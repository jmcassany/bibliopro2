<?php
 ...
 echo "<img id='cryptogram' img src='".$_SESSION['cryptdir']."cryptographp.php?cfg=".$cfg."&".SID."'>";
...
/* 
 echo "<table><tr><td><img id='cryptogram' img src='".$_SESSION['cryptdir']."cryptographp.php?cfg=".$cfg."&".SID."'></td>";
