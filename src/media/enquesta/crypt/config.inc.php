...
$charclear = 60;   // Intensité de la transparence des caractères (0->127)
...
$charsizemin = 18;      // Taille minimum des caractères
...
$cryptgaussianblur = true; // Transforme l'image finale en brouillant: méthode Gauss (true/false)
