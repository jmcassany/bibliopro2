...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
	...
	<head>
		...
		?>
		<title>!METAS_TITLE!Noticias - BiblioPRO</title>
		<meta name="description" content="Noticias de BiblioPRO" />
...
$rutaplana = ($pos = strpos('/servicios/noticias', '?')) ? substr('/servicios/noticias', 0, ($pos-1)) : '/servicios/noticias';
					...
					<form action="" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
						<div class="search searchDinamic clearfix">
							...
							<fieldset>
								...
								<input type="image" src="/media/img/bt_faqs_search.png" name="searchFaqs" value="Buscar" alt="Buscar" class="searchFaqs" />
							</fieldset>
						</div>
					</form>
