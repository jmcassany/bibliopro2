...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
	...
	<head>
		...
		?>
		<title>!METAS_TITLE!Preguntas frecuentes - BiblioPRO</title>
		<meta name="description" content="Preguntas frecuentes sobre BiblioPRO" />
...
<?php
$directori = '3,8';
$url = '/servicios/preguntas-frecuentes';
$rutaplana = ($pos = strpos('/servicios/preguntas-frecuentes', '?')) ? substr('/servicios/preguntas-frecuentes', 0, ($pos-1)) : '/servicios/preguntas-frecuentes';
				...
				<div id="content_main">
					...
					<form action="" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
						<div class="search searchDinamic clearfix">
							<h3><span>Buscador de preguntas frecuentes</span></h3>
							<fieldset>
								<label for="CATEGORY2">
									<span>Categoría:</span>
