...
jQuery.extend(jQuery.validator, {
	...
	messages: {
		...
		required_ca: "Aquest camp és obligatori.",
		required_es: "Este campo es obligatorio.",
		email: "Please enter a valid email address.",
		email_ca: "Si us plau, entreu una adreça de correu vàlida.",
		email_es: "Por favor, entre una dirección de correo válida.",
		url: "Please enter a valid URL.",
		url_ca: "Si us plau, entreu una url vàlida.",
		url_es: "Por favor, entre una url válida.",
		date: "Please enter a valid date.",
		date_ca: "Si us plau, entreu una data vàlida.",
		date_es: "Por favor, entre una data válida.",
		dateISO: "Please enter a valid date (ISO).",
		dateISO_ca: "Si us plau, entreu una data (ISO) vàlida.",
		dateISO_es: "Por favor, entre una data (ISO) válida.",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "Please enter a valid number.",
		number_ca: "Si us plau, entreu un número vàlid.",
		number_es: "Por favor, entre un número válido.",
		numberDE: "Bitte geben Sie eine Nummer ein.",
		digits: "Please enter only digits.",
		digits_ca: "Si us plau, entreu únicament dígits.",
		digits_es: "Por favor, entre únicamente dígitos.",
		creditcard: "Please enter a valid credit card.",
		creditcard_ca: "Si us plau, entreu  un número de targeta de crèdit vàlid.",
		creditcard_es: "Por favor, entre un número de tarjeta de crédito válido.",
		equalTo: "Please enter the same value again.",
		equalTo_ca: "Si us plau, entreu el mateix valor.",
		equalTo_es: "Por favor, entre el mismo valor.",
		accept: "Please enter a value with a valid extension.",
		accept_ca: "Si us plau, entreu un valor amb una extensió vàlida.",
		accept_es: "Por favor, entre un valor con una extensión válida.",
		maxLength: jQuery.format("Please enter a value no longer than {0} characters."),
		maxLength_ca: jQuery.format("Si us plau, entreu un valor de menys de {0} caràcters."),
		maxLength_es: jQuery.format("Por favor, entre un valor de menos de {0} caracteres."),
		minLength: jQuery.format("Please enter a value of at least {0} characters."),
		minLength_ca: jQuery.format("Si us plau, entreu un valor de més de {0} caràcters."),
		minLength_es: jQuery.format("Por favor, entre un valor de mas de {0} caracteres."),
		rangeLength: jQuery.format("Please enter a value between {0} and {1} characters long."),
		rangeLength_ca: jQuery.format("Si us plau, entreu un valor entre {0} i {1} caràcters de longitud."),
		rangeLength_es: jQuery.format("Por favor, entre un valor entre {0} y {1} caracteres de longitud."),
		rangeValue: jQuery.format("Please enter a value between {0} and {1}."),
		rangeValue_ca: jQuery.format("Si us plau, entreu un valor entre {0} i {1}."),
		rangeValue_es: jQuery.format("Por favor, entre un valor entre {0} y {1}."),
		maxValue: jQuery.format("Please enter a value less than or equal to {0}."),
		maxValue_ca: jQuery.format("Si us plau, entreu un valor més petit o igual a {0}."),
		maxValue_es: jQuery.format("Por favor, entre un valor mas pequeño o igual a {0}."),
		minValue: jQuery.format("Please enter a value greater than or equal to {0}."),
		minValue_ca: jQuery.format("Si us plau, entreu un valor més gran o igual a {0}."),
		minValue_es: jQuery.format("Por favor, entre un valor mas grande o igual a {0}.")
	},
	...
	methods: {
		...
		required_ca: function(value, element, param) {
			// check if dependency is met
			if ( !this.depend(param, element) )
				return -1;
			switch( element.nodeName.toLowerCase() ) {
		...
		required_es: function(value, element, param) {
			// check if dependency is met
			if ( !this.depend(param, element) )
				return -1;
			switch( element.nodeName.toLowerCase() ) {
		...
		minLength_ca: function(value, element, param) {
			return this.required(element) || this.getLength(value, element) >= param;
		},
		minLength_es: function(value, element, param) {
			return this.required(element) || this.getLength(value, element) >= param;
		},
		...
		maxLength_ca: function(value, element, param) {
			return this.required(element) || this.getLength(value, element) <= param;
		},
		maxLength_es: function(value, element, param) {
			return this.required(element) || this.getLength(value, element) <= param;
		},
		...
		rangeLength_ca: function(value, element, param) {
			var length = this.getLength(value, element);
			return this.required(element) || ( length >= param[0] && length <= param[1] );
		},
		rangeLength_es: function(value, element, param) {
			var length = this.getLength(value, element);
			return this.required(element) || ( length >= param[0] && length <= param[1] );
		},
		...
		minValue_ca: function( value, element, param ) {
			return this.required(element) || value >= param;
		},
		minValue_es: function( value, element, param ) {
			return this.required(element) || value >= param;
		},
		...
		maxValue_ca: function( value, element, param ) {
			return this.required(element) || value <= param;
		},
		maxValue_es: function( value, element, param ) {
			return this.required(element) || value <= param;
		},
		...
		rangeValue_ca: function( value, element, param ) {
			return this.required(element) || ( value >= param[0] && value <= param[1] );
		},
		rangeValue_es: function( value, element, param ) {
			return this.required(element) || ( value >= param[0] && value <= param[1] );
		},
		...
		email_ca: function(value, element) {
			return this.required(element) || /^[^\s,;]+@([^\s.,;]+\.)+[\w-]{2,}$/i.test(value);
		},
		email_es: function(value, element) {
			return this.required(element) || /^[^\s,;]+@([^\s.,;]+\.)+[\w-]{2,}$/i.test(value);
		},
		...
		url_ca: function(value, element) {
			// contributed by Scott Gonzalez: http://projects.scottsplayground.com/iri/
			return this.required(element) || /^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)*(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(value);
		},
		url_es: function(value, element) {
			// contributed by Scott Gonzalez: http://projects.scottsplayground.com/iri/
			return this.required(element) || /^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)*(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(value);
		},
		...
		date_ca: function(value, element) {
			return this.required(element) || !/Invalid|NaN/.test(new Date(value));
		},
		date_es: function(value, element) {
			return this.required(element) || !/Invalid|NaN/.test(new Date(value));
		},
		...
		dateISO_ca: function(value, element) {
			return this.required(element) || /^\d{4}[\/-]\d{1,2}[\/-]\d{1,2}$/.test(value);
		},
		dateISO_es: function(value, element) {
			return this.required(element) || /^\d{4}[\/-]\d{1,2}[\/-]\d{1,2}$/.test(value);
		},
		...
		number_ca: function(value, element) {
			return this.required(element) || /^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(value);
		},
		number_es: function(value, element) {
			return this.required(element) || /^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(value);
		},
		...
		digits_ca: function(value, element) {
			return this.required(element) || /^\d+$/.test(value);
		},
		digits_es: function(value, element) {
			return this.required(element) || /^\d+$/.test(value);
		},
		...
		creditcard_ca: function(value, element) {
			if ( this.required(element) )
				return true;
			var nCheck = 0,
				nDigit = 0,
		...
		creditcard_es: function(value, element) {
			if ( this.required(element) )
				return true;
			var nCheck = 0,
				nDigit = 0,
		...
		accept_ca: function(value, element, param) {
			param = typeof param == "string" ? param : "png|jpe?g|gif";
			return this.required(element) || value.match(new RegExp(".(" + param + ")$", "i")); 
		},
		accept_es: function(value, element, param) {
			param = typeof param == "string" ? param : "png|jpe?g|gif";
			return this.required(element) || value.match(new RegExp(".(" + param + ")$", "i")); 
		},
		...
		equalTo_ca: function(value, element, param) {
			return value == jQuery(param).val();
		},
		equalTo_es: function(value, element, param) {
			return value == jQuery(param).val();
		}
