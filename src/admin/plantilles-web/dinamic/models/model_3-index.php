...
if ($CATEGORY2 == 0 && $cerca == '') {

    // llista de categories
    $data['LLISTA_CATEGORIES'] = getLlistaCategories($ID_CARPETA, "levels=1");

    if ($data['LLISTA_CATEGORIES'] != '') {
        $data['LLISTA_CATEGORIES'] = '<h3>Categories</h3><ul>' . $data['LLISTA_CATEGORIES'] . '</ul>';
    }

    // OUTPUT =====================================================
    $content.= $Tpl->mergeBlock('CERCADOR', $data);
