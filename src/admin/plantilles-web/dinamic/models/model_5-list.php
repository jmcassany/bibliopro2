...
function getPageLink($page) {
    ...
    return $pathEditora.'list.php?CATEGORY2=' . $CATEGORY2 . '&amp;PAGE=' . $page . $filtre_cerca;
}
...
$data['LLISTA_CATEGORIES'] = getLlistaCategories($ID_CARPETA, "levels=1&link_to=list.php&display_childs_from_category=" . $CATEGORY2);

if ($data['LLISTA_CATEGORIES'] != '') {
    $data['LLISTA_CATEGORIES'] = '<h2>Categories</h2><ul>' . $data['LLISTA_CATEGORIES'] . '<li><a href="'.$pathEditora.'list.php">Totes les categories</a></li></ul>';
}

// OUTPUT LLISTA_CATEGORIES =====================================================
$content.= $Tpl->mergeBlock('LLISTA_CATEGORIES', $data);
