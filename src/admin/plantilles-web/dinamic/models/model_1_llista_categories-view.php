...
$data['LLISTA_CATEGORIES'] = getLlistaCategories($ID_CARPETA, "levels=1&display_childs_from_category=" . $data['CATEGORY2']);
...
$data['SELECT_CATEGORIES'] = '<select name="CATEGORY2" onchange="submit();">
								' . getSelectOptionsCategories($ID_CARPETA, "selected_category=" . $data['CATEGORY2'] . "&default_option_text=Totes les categories") . '
							   </select>';

// SITUACIO
//posem link al nom carpeta xq retorni a l'index;
$arraySituacio[count($arraySituacio)-1]['link'] = $CONFIG_NOMCARPETA.'/'.folderPath($ID_CARPETA).'/index.php';
