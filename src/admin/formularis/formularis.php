<?php
    ...
    // list definitions
    $CARDS_LISTSORTBY = 'NOMFORMULARI asc, START_TIME desc';
	...
	$CARDS_FIELDS['NOMFORMULARI']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['TITOLFORMULARI']            = array('CUSTOM', 'CHAR',  'CHAR');
	...
	$CARDS_FIELDS['ACTION']         = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['RECIPIENT']         = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['REDIRECT']         = array('CUSTOM', 'CHAR',  'CHAR');
