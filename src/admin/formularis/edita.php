...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<tr>
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="50%" class="text10"><img src="../comu/icon_plana.gif" width="33" height="18" alt="<?php echo t("youarein"); ?>" border="0" align="absmiddle"><?php echo t("youarein"); ?>: <a href="../index.php"><?php echo t("home"); ?></a><img src="../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="index.php"><?php echo t("formstitle"); ?></a><img src="../comu/kland_etsa.gif" width="19" height="5"  border="0"><font class="blau10b"><?php echo t("update")." ".t("form"); ?></font></td>
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td  style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="../comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom"><?php echo t("formsconfig"); ?>: <?php echo $row['NOMFORMULARI']; ?></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			...
			<TR>
			   ...
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="NOMFORMULARI" VALUE="<?php echo $row['NOMFORMULARI']; ?>" SIZE="50" MAXLENGTH="250" class="formulari"></TD>
			</TR>
			<TR>
			   <TD class=text valign=top width="20%"><?php echo t("title"); ?>:</TD>
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="TITOLFORMULARI" VALUE="<?php echo filtreQuote($row['TITOLFORMULARI']); ?>" SIZE="50" MAXLENGTH="250" class="formulari"></TD>
			</TR>
			<TR>
			   <TD class=text valign=top width="20%"><?php echo t("description"); ?>:</TD>
			   <TD valign=top width="80%">
			   	<?php
				echo editor_entry("DESCRIPCIO", $row['DESCRIPCIO'],'Antaviana');
				?>
			...
			<TR>
			   ...
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="RECIPIENT" VALUE="<?php echo filtreQuote($row['RECIPIENT']); ?>" SIZE="50" MAXLENGTH="250" class="formulari"></TD>
			</TR>
			<TR>
			   <TD class=text valign=top width="20%"><?php echo t("formsconfigurlreturn"); ?>:</TD>
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="REDIRECT" VALUE="<?php echo filtreQuote($row['REDIRECT']); ?>" SIZE="50" MAXLENGTH="250" class="formulari"></TD>
			</TR>
...
?>
	...
	<?php
		 echo staticFolderSelect($row['PARE']);
	...
	<tr>
	   ...
	   <td valign=top width="60%">
		<select class="formulari" name="MENU1" style="width:250px;">
			...
			<?php
echo menu_list($row['MENU1'], 0, $row['PARE']);
			?>
		</select>
		</td>
	</tr>
	<tr>
	   ...
	   <td valign=top width="60%">
		<select class="formulari" name="MENU2" style="width:250px;">
			<option value=""><?php echo t("none"); ?></option>
			<?php
echo menu_list($row['MENU2'], 0, $row['PARE']);
			?>
		</select>
		</td>
	</tr>
	<tr>
	   ...
	   <td valign=top width="60%">
		<select class="formulari" name="MENU3" style="width:250px;">
			<option value=""><?php echo t("none"); ?></option>
			<?php
echo menu_list($row['MENU3'], 1, $row['PARE']);
			?>
		</select>
...
<!-- METAS bloc -->
	...
	<tr>
		...
		<td width="60%"  style="padding-left:5px;padding-bottom:5px;"><input type="text" name="METATITOL" value="<?php echo filtreQuote($row['METATITOL']); ?>" maxlength="500" class="formulari" style="width:430px;"></b></td>
	</tr>
	<tr>
		<td class="text10" style="padding-left:5px;padding-bottom:5px;"><?php echo t("description"); ?></td>
		<td width="60%"  style="padding-left:5px;padding-bottom:5px;"><input type="text" name="METADESCRIPCIO" value="<?php echo filtreQuote($row['METADESCRIPCIO']); ?>" maxlength="500" class="formulari" style="width:430px;"></b></td>
	</tr>
	<tr>
		<td class="text10" style="padding-left:5px;padding-bottom:5px;"><?php echo t("keywords"); ?></td>
		<td width="60%" style="padding-left:5px;padding-bottom:5px;"><input type="text" name="METAKEYS" value="<?php echo filtreQuote($row['METAKEYS']); ?>" maxlength="500" class="formulari" style="width:430px;"></td>
	</tr>
<!-- /METAS bloc -->
...
?>
			...
			<TR>
			   ...
			   <INPUT TYPE="submit" NAME="accion" VALUE="<?php echo t("update")." ".t("form"); ?>" class=boto>
			   </TD>
			</TR>
