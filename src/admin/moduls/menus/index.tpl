...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<!-- situacio Sou a -->
	<tr>
		<td  class="text" bgcolor="#C0CEE4" style="padding:6px;"><img src="../../comu/kland_blanc.gif" width="22" height="7" border="0" align="absmiddle"><b>Gesti� de men�s</b></td>
	</tr>
	<tr>
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="50%" class="text10"><img src="../../comu/icon_plana.gif" width="33" height="18" alt="|LANG_YOUAREIN|" border="0" align="absmiddle">|LANG_YOUAREIN|: <a href="../../index.php">|LANG_HOME|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><font class="blau10b">|LANG_MENUTITLE|</font></td>
...
|NEWMENU|
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td  style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="../../comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">|LANG_MENU| (|TOTAL|)</td>
...
<a href="veure.php?menu=|NOM|" target="_blank"><img src="../../comu/icon_veure.gif" alt="Veure" width="19" height="16" border="0" align="absmiddle"></a>
|EDIT_OPTION|
|CLONE_OPTION|
<a href="preview.php?ID=|ID|"><img src="../../comu/|GENERAR|" alt="Generar" width="23" height="16" border="0" align="absmiddle"></a>
|DELETE_OPTION|
					</td>
|MENU_INFO|
				</tr>
