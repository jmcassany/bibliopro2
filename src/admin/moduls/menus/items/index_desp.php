...
accessGroupPermCheck('menu_entrys');
   ...
   $idmenu=$row['MENU'];
   $identrada=$row['ID'];
   $result=db_query("select * from MENUS where ID = $idmenu");
   $row = db_fetch_array($result);
   $nommenu=$row['NOM'];
   if(empty($row['NOM'])){
		...
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td  class="text10" width="70%"><img src="../../../comu/icon_plana.gif" width="33" height="18" alt="<?php echo t("youarein"); ?>" border="0" align="absmiddle"><?php echo t("youarein"); ?>: <a href="../../../index.php"><?php echo t("home"); ?></a><img src="../../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="../index.php"><?php echo t("menutitle"); ?></a><img src="../../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="index.php?ID=<?php echo $idmenu; ?>"><?php echo $nommenu; ?></a><img src="../../../comu/kland_etsa.gif" width="19" height="5"  border="0"><font class="blau10b"><?php echo $nomentrada; ?></font></td>
					<td  class="vermell10b" align="right">
<form action="nou_desp.php" method="post" name="FormCrearpagina"  style="display:inline">
...
<button type="submit" class="vermell10b" style="background-color:transparent;cursor:pointer;border:none;text-decoration: none;">
  <img src="../../../comu/inserta_c_menu.gif" alt="<?php echo t("submenunewitem"); ?>" align="absmiddle" style="margin-right:5px;" /><?php echo t("submenunewitem"); ?>
</button>
</form>
					</td>
				</tr>
	...
	<tr>
		<form action="delete_desp.php" method="post">
...
<?php
   ...
   $result = db_query("SELECT * FROM MENUITEMSSUB WHERE MENUITEM='$ID' ORDER BY ORDRE ASC,ID DESC");
   ...
   while($row = db_fetch_array($result)) {
        	echo("<tr>
					<td width=\"20%\" style=\"border-bottom:solid #cccccc 1px;border-right:solid #cccccc 1px;\">
						...
						<a href=\"edita_desp.php?ID=".$row['ID']."\"><img src=\"../../../comu/icon_modifica.gif\" alt=\"Editar\" width=\"23\" height=\"16\" border=\"0\" align=\"absmiddle\" ></a>
						<a href=\"moure_desp.php?ID=".$row['ID']."&accio=up\"><img src=\"../../../comu/icon_pujaform.gif\" alt=\"Pujar\" width=\"13\" height=\"14\" border=\"0\" align=\"absmiddle\" style=\"margin-right:4px;\"></a>
						<a href=\"moure_desp.php?ID=".$row['ID']."&accio=down\"><img src=\"../../../comu/icon_baixaform.gif\" alt=\"Baixar\" width=\"13\" height=\"14\" border=\"0\" align=\"absmiddle\" ></a>
						&#149;&nbsp;
					...
					<td class=\"gris10\" width=\20%\" valign=\"top\" style=\"border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;\"><a href=\"edita_desp.php?ID=".$row['ID']."\"><img src=\"../../../comu/ico_c_menu.gif\" width=\"29\" height=\"17\"  border=\"0\" align=\"absmiddle\"></a><a href=\"edita_desp.php?ID=".$row['ID']."\" class=\"nompagina\" title=\"vincle:".$row['LINKPAGE']."\">".$row['TEXT']."</a></td>
