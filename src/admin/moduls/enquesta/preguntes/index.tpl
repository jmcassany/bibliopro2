...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">			
	...
	<tr>
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">	
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="70%" class="text10"><img src="../../../comu/icon_plana.gif" width="33" height="18" alt="|LANG_YOUAREIN|" border="0" align="absmiddle">|LANG_YOUAREIN|: <a href="../../../index.php">|LANG_HOME|</a><img src="../../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="../../../utilitats/index.php">|LANG_UTILS|</a><img src="../../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="../index.php">|LANG_POLLTITLE|</a><img src="../../../comu/kland_etsa.gif" width="19" height="5"  border="0"><font class="blau10b">|LANG_POLLQUERYTITLE|</font></td>
					
					<td class="vermell10b" align="right">
						<a href="nou.php?ENQUESTA=|ENQUESTA|" class="vermell10b"><img src="../../../comu/inserta_menu.gif" alt="|LANG_POLLQUERYCREATE|" width="26" height="19" border="0" align="absmiddle">
						|LANG_POLLQUERYCREATE|</a>
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td  style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="../../../comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">|LANG_POLLQUERY| |DESC_ENQ| (|TOTAL|)</td>
