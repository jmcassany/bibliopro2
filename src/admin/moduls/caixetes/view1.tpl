...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">			
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			...
			<TR>
			   <TD class=text valign=top width="20%">|LANG_WIDTH|:</TD>
               <TD valign=top width="80%"><INPUT TYPE="text" NAME="WIDTH"  VALUE="|WIDTH|" SIZE="10" MAXLENGTH="10" class="formulari"></TD>
			</TR>
			<TR>
			   <TD class=text valign=top width="20%">|LANG_HEIGHT|:</TD>
               <TD valign=top width="80%"><INPUT TYPE="text" NAME="HEIGHT"  VALUE="|HEIGHT|" SIZE="10" MAXLENGTH="10" class="formulari"></TD>
			</TR>

			<TR>
			   <TD class=text valign=top width="20%">|LANG_FLASH|:</TD>
			   <TD valign=top width="80%"><input type=file name="img" size=50 class="formulari"></TD>
			</TR> 
			<TR> 
			   <TD class=text valign=top width="20%">|LANG_ALT|:</TD>
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="TITOL"  VALUE="|TITOL|" SIZE="50" MAXLENGTH="250" class="formulari"></TD> 
			</TR>
			<TR>
			   <TD class=text valign=top width="20%">|LANG_IMAGE|:</TD>
			   <TD valign=top width="80%"><input type=file name="img1" size=50 class="formulari"></TD>
			</TR>
