<?php
    ...
    $CARDS_FIELDS['LINKC']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['IMATGE']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['IMATGE_ALTERNATIVA']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['FINESTRA']        = array('CUSTOM', 'ITEM', 'CARDS_FINESTRA');
	$CARDS_FIELDS['TIPO']               = array('CUSTOM', 'NUMBER', '');
	$CARDS_FIELDS['TITOL']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['WIDTH']               = array('CUSTOM', 'NUMBER', '');
	$CARDS_FIELDS['HEIGHT']               = array('CUSTOM', 'NUMBER', '');
	$CARDS_FIELDS['TEXT']            = array('CUSTOM', 'TEXT',  'TEXT');
