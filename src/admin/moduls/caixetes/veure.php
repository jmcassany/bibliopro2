...
$targetfilename = $CONFIG_PATHBOX."/".$caixeta.'.inc';
if (file_exists($targetfilename)) {
  include($targetfilename);
}else{
  echo ("<center><img src=\"../../comu/houdini_alerta.gif\" width=\"19\" height=\"31\" alt=\"Alerta\" border=\"0\" align=\"absmiddle\"> <font class=\"grana\" hspace=\"5\"><B>".t('bannersviewerror')."</B><br><a href=\"javascript:window.close();\"><b>".t('close')."</b></a></font></center>");
}
?>
</body></html>
