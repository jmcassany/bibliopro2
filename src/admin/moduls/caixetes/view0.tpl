	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			...
			<TR> 
			   ...
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="LINKC"  VALUE="|LINKC|" SIZE="50" MAXLENGTH="250" class="formulari"></TD> 
			</TR>
			<TR> 
			   <TD class=text valign=top width="20%">|LANG_NEWWINDOW|?</TD>
			   <TD valign=top width="80%">|SELECT_FINESTRA|</TD> 
			</TR>
			<TR> 
			...
			<TR>   
			   ...
			   <INPUT TYPE="submit" NAME="accion" VALUE="|LANG_UPDATE|">
			   </TD> 
			</TR>
