			...
			<table>
				...
				|LINIES_ENVIADES|
					...
					<!-- BLOCK_BEGIN_LINIA_DESADES  -->
						<tr>
							<th><a href="campanyes/resum.php?id=|ID|">|TITOL|</a></th>
							<td>|D_ALTA|</td>
							<td>|D_MODIF|</td>
							<td>|PAS1|</td>
							<td>|PAS2|</td>
							<td>|PAS3|</td>
							<td><a href="campanyes/resum.php?id=|ID|"><img src="media/comu/bt_editar.gif" width="71" height="27" alt="Editar" /></a></td>
							<td><a href="campanyes/elimina.php?id=|ID|"><img src="media/comu/bt_esborrar.gif" width="71" height="27" alt="Esborrar" /></a></td>
						</tr>
...
<!-- BLOCK_BEGIN_PAS_KO  --><img src="media/comu/ico_enviat_error2.jpg" alt="Incorrecte" width="21" height="21" /><!-- BLOCK_END_BOTO_PAS_KO  -->
					...
					<!-- BLOCK_BEGIN_LINIA_ENVIADES  -->
						<tr>
							...
							<td><a href="informes/resum.php?id=|ID|"><img src="media/gif/bt_veurela.gif" width="71" height="27" alt="Veure" /></a></td>
							<td><a href="campanyes/duplica.php?id=|ID|"><img src="media/gif/bt_duplica.gif" width="71" height="27" alt="Duplicar" /></a></td>
							<td><a href="campanyes/elimina.php?id=|ID|"><img src="media/gif/bt_esborrar.gif" width="71" height="27" alt="Esborrar" /></a></td>
						</tr>
