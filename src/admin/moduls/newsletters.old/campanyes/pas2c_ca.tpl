<div id="contenidor" class="crear pas2">
		...
		<div id="contingut">
			...
			|T_MISSATGE|
				...
				<!-- <a href="mostra.php?id=|ID|" onclick="javascript:return launchPreview('mostra.php?id=|ID|')" class="previ"><img src="../media/comu/bt_previsual.jpg" width="286" height="39" alt="Previsualitzar la meva Newsletter" /></a> -->
				|BOTO_PAS_SEGUENT2|		
				...
				<div id="botons">
					<a href="pas2b.php?id=|ID|" class="boto anterior">Anterior</a>
