...
-->
		...
		<TR> 
		   <TD class=text valign=top width="20%">Títol:</TD> 
		...
		<TR> 
		  <TD valign=top colspan="2" class="text10" style="background-color:#EAEAEA;padding:5px 10px;">
		   ...
		   <div id="capaOpcions">
		   		...
		   		|MESINFO|
				<table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-top:solid #CCCCCC 1px;border-bottom:solid #CCCCCC 1px;">
				<tr>
					<td valign="top" style="padding:5px;">|ADJUNT5|</td>
					<td style="padding:5px;" class="text10">
						Nom del document: <INPUT TYPE="text" NAME="NOMAD5" value="|NOMAD5|" SIZE="60" MAXLENGTH="60"><br>
						Document: <input type="file" name="file4" size="60"><br>
						(|LANG_FORMATS|: <b>.pdf</b> <b>.doc</b> <b>.xls</b> <b>.ppt</b> <b>.zip</b> | |LANG_MIDAMAXIMA|: <b>500K</b>)
					</td>
				</tr>
				</table>
				<br>
				Nom de l'enllaç : <INPUT TYPE="text" NAME="NOM_LINK" value="|NOM_LINK|" SIZE="60" MAXLENGTH="60"><br>
				Enllaç: <input type="text" name="LINK2" size="60" value="|LINK2|"><br>
			</div>
		   </TD> 
		</TR>
		<tr>
