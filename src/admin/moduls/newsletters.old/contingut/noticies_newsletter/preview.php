...
$result = mysql_query("SELECT * FROM NOTICIES_NEWSLETTER Where ID='$ID'");
...
<?php 
	...
	//imatge 1
	$imatge1 = $row['IMATGE1'];
    if ($row['IMATGE1'] != "") $img1 = "<img src=\"../../../../../public/media/upload/noticies_newsletter/imgs/p$imatge1\" border=\"0\" style=\"float:left;margin:0 5 5 0;\">";
	...
	//if($row['MESINFO'] == '1'){
	if($row['DESCRIPCIO'] != ''){
		$mesinfo = "<font class=\"blautitol10\"><img src=\"../../../../../public/media/comu/admin/icon_mesinfo.gif\" width=13 height=11 border=0>".$messages["mesinfo"]."</font>";
	}else{
		$mesinfo = "";
	}
