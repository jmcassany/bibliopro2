<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #F66013 5px;margin:10px;">			
	...
	<tr>
		<td colspan="2" style="padding-left:10px;padding-top:10px;padding-right:10px;">	
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td align="right"><a href="new.php" class="vermell10b"><img src="../../../../../public/media/comu/admin/icon_afegir_plana.gif" alt="" width="18" height="19" border="0" align="absmiddle"> Crear capçalera</a></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">					
				<tr bgcolor="#efefef">
					...
					<td class="gris11b" width="55%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=titol&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Nom</a></td>
