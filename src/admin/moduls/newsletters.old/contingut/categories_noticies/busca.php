...
// ============================================================================
   ...
   accessCheckLevel(2, $CONFIG_PRE_NOMCARPETA.'/admin/');
	...
	$CARDS_LISTFILTER .= " and (TITOL LIKE '%$recerca%')";
...
// ------------------
   ...
   $data['PAGELIST']=$pagelist.' ';
	...
	if ($ordenar == "ordrecat") {
		$CARDS_LISTSORTBY = 'ORDRECAT '.$ordre;
		$data['COLOR4']="#DEDEDE";
	...
	if ($ordenar == "color") {
		$CARDS_LISTSORTBY = 'COLOR '.$ordre;
		$data['COLOR5']="#DEDEDE";
		$data['ICO5']="<img src=\"../../../../../public/media/comu/admin/$ordre.gif\" width=\"10\" height=\"10\"  border=\"0\" align=\"absmiddle\" hspace=\"5\">";
		if ($ordre == "DESC") {
			$ordre = "ASC";
		} else {
			$ordre = "DESC";
   ...
   for ($i=0; $i<$total; $i++)
   {
       ...
       if($data['ID'] == 1){
       		...
       		$data['OPCIONS_CATEG'] = '<a href="view.php?ID='.$data['ID'].'"><img src="../../../../../public/media/comu/admin/icon_modifica.gif" alt="Editar" width="23" height="16" border="0" align="absmiddle"></a>&#149;&nbsp;
