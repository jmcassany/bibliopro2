...
<tr>
	<td colspan="2" style="padding-left:10px;padding-top:10px;padding-right:10px;">	
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td align="right"><a href="new.php" class="vermell10b"><img src="../../../../../public/media/comu/admin/icon_afegir_plana.gif" alt="" width="18" height="19" border="0" align="absmiddle"> |LANG_CREARCATEGORIA|</a></td>
			</tr>
		</table>
	</td>
</tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td colspan="2" bgcolor="#ECECEC" style="padding:5px;border-bottom:solid #CCCCCC 1px;" class="text10">
					|LANG_LLEGENDES|:&nbsp;&nbsp;&nbsp;
					<img src="../../../../../public/media/comu/admin/icon_modifica.gif" alt="" width="23" height="16" border="0" align="absmiddle" >|LANG_EDITARCATEGORIA|&nbsp;&nbsp;&nbsp;
					<img src="../../../../../public/media/comu/admin/icon_borrar.gif" alt="" width="22" height="16" border="0" align="absmiddle">|LANG_ELIMINARCATEGORIA|&nbsp;&nbsp;&nbsp;
					<img src="../../../../../public/media/comu/admin/icon_baixaform.gif" alt="" width="13" height="14" border="0" align="absmiddle"> <img src="../../../../../public/media/comu/admin/icon_pujaform.gif" alt="" width="13" height="14" border="0" align="absmiddle"> |LANG_CANVIARORDRE|
				</td>
			</tr>
			<!-- /llegendes -->
			<!-- navegacio pag -->	
	...
	<td colspan="2" style="padding:10px;" valign="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">					
			<tr bgcolor="#efefef">
				...
				<td class="gris11b" width="45%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=titol&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Títol categoria</a></td>
				<!--<td class="gris11b" width="10%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=color&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR5|;" class="titolllistat">|ICO5||LANG_COLOR|</a></td>-->
				<td class="gris11b" width="15%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=data&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR2|;" class="titolllistat">|ICO2||LANG_CREACIO|</a></td>
				<td class="gris11b" width="10%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=estat&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR3|;" class="titolllistat">|ICO3||LANG_ESTAT|</a></td>
				<td class="gris11b" width="10%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=ordrecat&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR4|;" class="titolllistat">|ICO4||LANG_ORDRE|</a></td>
			</tr>	
			<!-- BLOCK_BEGIN_ROW1  -->
			<tr>
				<td style="border-bottom:solid #cccccc 1px;" align="center">
					|OPCIONS_CATEG|
					<a href="moure.php?ID=|ID|&accio=down"><img src="../../../../../public/media/comu/admin/icon_pujaform.gif" alt="|LANG_PUJAR|" width="13" height="14" border="0" align="absmiddle" style="margin-right:4px;"></a>						
					<a href="moure.php?ID=|ID|&accio=up" ><img src="../../../../../public/media/comu/admin/icon_baixaform.gif" alt="|LANG_BAIXAR|" width="13" height="14" border="0" align="absmiddle"></a>						
				</td>
				...
				<!--<td class="gris11" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;" bgcolor="|COLOR|">&nbsp;</td>-->
				...
				<td class="gris11" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;">|ORDRECAT|</td>
			</tr>	
			<!-- BLOCK_END_ROW1  -->
			<!-- BLOCK_BEGIN_ROW2  -->
			<tr>
