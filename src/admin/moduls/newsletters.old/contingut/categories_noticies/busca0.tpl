	...
	<td colspan="2" style="padding:10px;" valign="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">					
			<tr bgcolor="#efefef">
				...
				<td class="gris11b" width="45%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="busca.php?ordenar=titol&ordre=|ORDRE|&recerca=|RECERCA|&PAGE=|PAGE|" style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Títol categoria</a></td>
				<!--<td class="gris11b" width="10%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="busca.php?ordenar=color&ordre=|ORDRE|&recerca=|RECERCA|&PAGE=|PAGE|" style="background-color:|COLOR5|;" class="titolllistat">|ICO5||LANG_COLOR|</a></td>-->
				...
				<td class="gris11b" width="10%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="busca.php?ordenar=ordrecat&ordre=|ORDRE|&recerca=|RECERCA|&PAGE=|PAGE|" style="background-color:|COLOR4|;" class="titolllistat">|ICO4||LANG_ORDRE|</a></td>
			</tr>	
			<!-- BLOCK_BEGIN_ROW1  -->
			<tr>
				<td style="border-bottom:solid #cccccc 1px;" align="center">
					|OPCIONS_CATEG|
					<a href="moure.php?ID=|ID|&accio=down&opcio=cercador"><img src="../../../../../public/media/comu/admin/icon_pujaform.gif" alt="|LANG_PUJAR|" width="13" height="14" border="0" align="absmiddle" style="margin-right:4px;"></a>						
					<a href="moure.php?ID=|ID|&accio=up&opcio=cercador" ><img src="../../../../../public/media/comu/admin/icon_baixaform.gif" alt="|LANG_BAIXAR|" width="13" height="14" border="0" align="absmiddle"></a>						
				</td>
