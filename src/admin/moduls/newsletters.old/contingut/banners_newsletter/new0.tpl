...
<tr>
	...
	<td colspan="2" style="padding:10px;" valign="top">
		...
		<TR> 
		   ...
		   <TD valign=top width="80%"><INPUT TYPE="text" NAME="LINK" SIZE="60" MAXLENGTH="150"></TD> 
		</TR> 
		<TR> 
		   <TD class=text valign=top width="20%">|LANG_IMATGE|:</TD> 
		...
		<TR>   
		   <TD colspan="2" style="border-top:solid #0E449A 1px;">
		   		<br>
				<INPUT TYPE="Button" NAME="accion" VALUE="|LANG_CREARBANNER|" onclick="javascript:dades();"> 
		   </TD> 
		</TR>
		</table>
	</td>
