	...
	<td colspan="2" style="padding:10px;" valign="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">					
			<tr bgcolor="#efefef">
				...
				<td class="gris11b" width="55%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="busca.php?ordenar=titol&ordre=|ORDRE|&recerca=|RECERCA|&PAGE=|PAGE|" style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Títol banner</a></td>
