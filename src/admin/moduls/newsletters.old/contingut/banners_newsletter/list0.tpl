...
<tr>
	<td colspan="2" style="padding-left:10px;padding-top:10px;padding-right:10px;">	
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td align="right"><a href="new.php" class="vermell10b"><img src="../../../../../public/media/comu/admin/icon_afegir_plana.gif" alt="" width="18" height="19" border="0" align="absmiddle"> |LANG_CREARBANNER|</a></td>
			</tr>
		</table>
	</td>
</tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td colspan="2" bgcolor="#ECECEC" style="padding:5px;border-bottom:solid #CCCCCC 1px;" class="text10">
					|LANG_LLEGENDES|:&nbsp;&nbsp;&nbsp;
					<img src="../../../../../public/media/comu/admin/icon_veure.gif" alt="" width="19" height="16" border="0" align="absmiddle">|LANG_VEUREBANNER|&nbsp;&nbsp;&nbsp;
					<img src="../../../../../public/media/comu/admin/icon_modifica.gif" alt="" width="23" height="16" border="0" align="absmiddle" >|LANG_EDITARBANNER|&nbsp;&nbsp;&nbsp;
					<img src="../../../../../public/media/comu/admin/icon_borrar.gif" alt="" width="22" height="16" border="0" align="absmiddle">|LANG_ELIMINARBANNER|&nbsp;&nbsp;&nbsp;
				</td>
			</tr>
			<!-- /llegendes -->
			<!-- navegacio pag -->	
	...
	<td colspan="2" style="padding:10px;" valign="top">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">					
			<tr bgcolor="#efefef">
				...
				<td class="gris11b" width="55%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=titol&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Títol banner</a></td>
