	...
	if ($_REQUEST['add']){
		...
		echo "<script>
				function envia_tanca(){
					...
					parent.opener.location='edita.php?ID='+ID+'&noticia_newsletter='+noticia_newsletter+'&id_cat=-1&IdCam='+IdCam;
					self.close(); 
				}
			</script>";
		...
		if ($row['IMATGE1'] != "") { $img1 = "<img src=\"../../../../../public/media/upload/noticies_newsletter/imgs/$row[IMATGE1]\" border=\"0\" style=\"float:left;margin:0 5 5 0;\">"; } else { $img1 = ""; }
		
		if ($row['MESINFO'] == '1') { $mesinfo = "<img src=\"../../../../../public/media/comu/admin/icon_mesinfo.gif\" width=13 height=11 border=0> <font class=\"blautitol10\">".t("mesinfo")."</font>"; } else { $mesinfo = ""; }
		...
		$opcions = "<form action=\"afegir_noticia3.php\" method=\"post\" name=\"form_sel\"><BR>
...
<!-- CERCADOR -->
<form action="afegir_noticia3.php">	
...
<?php
	if ($_REQUEST['accion']){
		...
		echo "<form action=\"afegir_noticia3.php\" method=\"post\">";
