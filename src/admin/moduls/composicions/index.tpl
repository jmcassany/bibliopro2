...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<!-- situacio Sou a -->
	<tr>
		<td  class="text" bgcolor="#C0CEE4" style="padding:6px;"><img src="../../comu/kland_blanc.gif" width="22" height="7" border="0" align="absmiddle"><b>|LANG_BANNERSGROUPTITLE|</b></td>
	</tr>
	<tr>
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="50%" class="text10"><img src="../../comu/icon_plana.gif" width="33" height="18" alt="|LANG_YOUAREIN|" border="0" align="absmiddle">|LANG_YOUAREIN|: <a href="../../index.php">|LANG_HOME|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="../../utilitats/index.php">|LANG_UTILS|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><font class="blau10b">|LANG_BANNERSGROUPTITLE|</font></td>

					<td class="vermell10b" align="right">
						<a href="../caixetes/index.php" class="vermell10b"><img src="../../comu/icogestiona_caixes.gif" alt="|LANG_BANNERSTITLE|" width="26" height="19" border="0" align="absmiddle">
						|LANG_BANNERSTITLE|</a>
                        &nbsp;&nbsp;&nbsp;
						<a href="nou.php" class="vermell10b"><img src="../../comu/inserta_menu.gif" alt="|LANG_BANNERSGROUPCREATE|" width="26" height="19" border="0" align="absmiddle">
						|LANG_BANNERSGROUPCREATE|</a>
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td  style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="../../comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">|LANG_BANNERSGROUP| (|TOTAL|)</td>
				...
				<tr>
					<td  bgcolor="#ECECEC" style="padding:5px;border-bottom:solid #CCCCCC 1px;" class="text10">
						...
						<img src="../../comu/icon_generar.gif" alt="|LANG_GENERATE|" width="23" height="16" border="0" align="absmiddle">|LANG_GENERATE|&nbsp;&nbsp;&nbsp;
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="25%" style="border-bottom:solid #cccccc 1px;border-right:solid #cccccc 1px;">
						<a href="veure.php?banner=|NOM|" target="_blank"><img src="../../comu/icon_veure.gif" alt="|LANG_VIEW|" width="19" height="16" border="0" align="absmiddle"></a>
						...
						<a href="preview.php?ID=|ID|"><img src="../../comu/|GENERAR|" alt="|LANG_GENERATE|" width="23" height="16" border="0" align="absmiddle"></a>
						&#149;&nbsp;
						<img src="../../comu/icon_borrar.gif" alt="|LANGDELETE|" width="22" height="16" border="0" align="absmiddle"><input type="checkbox" name="CHECK[|ID|]" value="TRUE" >
					</td>
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID=|ID|"><img src="../../comu/icon_menus.gif" alt="Creat: |CREATION|" width="22" height="17" border="0" align="absmiddle"></a><a href="view.php?ID=|ID|" class="nompagina" title="Creat: |CREATION| |NOM|">|DESCRIPCIO|</a></td>
   					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID=|ID|" class="nompagina">|TIPUS|</td>
	...
	<tr>
		...
		<!-- CONFIRMACIO BORRAR -->
			<table border="0" cellspacing="4" cellpadding="4" width="100%" bgcolor="#ECECEC" height="33" style="border-top:solid #000000 1px;">
				<tr>
					<td  class="text">&nbsp;|LANG_CONFIRMDELETE|&nbsp;<img src="../../comu/icon_borrar.gif" alt="|LANG_DELETE|" width="22" height="16" border="0" align="absmiddle"><input type="checkbox" name="CONFIRM" value="TRUE"><input type="image" src="../../comu/confirma_elimina.gif" name="accio" value="Borrar" class="text10" align="absmiddle"></td>
				</tr>
			</table>
		<!-- /CONFIRMACIO BORRAR -->
		</td>
