		...
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
                    ...
                    <img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0">
                    <font class="blau10b">Generar composicions</font>
                    </td>
...
$result = db_query('SELECT * FROM BANNERS');
while ($row = db_fetch_array($result)) {
	$caixetes = explode('|',$row['TEXT']);

	$contents = call_user_func($tipus_banners[$row['TIPO']]['crear'],$row,$caixetes);
...
<font class="grana">Composició no generada</font> | '.$row['NOM'].'</font>
<br><br>';
	...
	echo '
<img src="../../comu/miniico_nova.gif" alt="Ok" border="0" align="left" ><font class="blau11b">Composició creada</font> |<a href="veure.php?banner='.$row['NOM'].'" target="_blank" class="text">'.$row['NOM'].'</a><br><br>
	';
	}
