		...
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
                    ...
                    <img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0">
                    <font class="blau10b">Generar visualitzadors Rss</font>
                    </td>
...
$result = db_query('SELECT * FROM VIEWRSS');
...
while ($row = db_fetch_array($result)) {
  ...
  if (file_exists($plantillafile)) {
	...
	echo '
<img src="../../comu/miniico_nova.gif" alt="Ok" border="0" align="left" ><font class="blau11b">Rss creat</font> |<a href="veure.php?rss='.$row['NOM'].'" target="_blank" class="text">'.$row['NOM'].'</a><br><br>
	';
...
<font class="grana">Rss no generat</font> | '.$row['NOM'].'</font>
<br><br>';
   }
}
