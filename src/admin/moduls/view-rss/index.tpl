...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">			
	...
	<!-- situacio Sou a -->
	<tr>
		<td  class="text" bgcolor="#C0CEE4" style="padding:6px;"><img src="../../comu/kland_blanc.gif" width="22" height="7" border="0" align="absmiddle"><b>|LANG_VIEWRSSTITLE|</b></td>
	</tr>
	<tr>
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">	
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="50%" class="text10"><img src="../../comu/icon_plana.gif" width="33" height="18" alt="|LANG_YOUAREIN|" border="0" align="absmiddle">|LANG_YOUAREIN|: <a href="../../index.php">|LANG_HOME|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="../../utilitats/index.php">|LANG_UTILS|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><font class="blau10b">|LANG_VIEWRSSTITLE|</font></td>
					
					<td class="vermell10b" align="right">
						<a href="nou.php" class="vermell10b"><img src="../../comu/inserta_menu.gif" alt="|LANG_VIEWRSSCREATE|" width="26" height="19" border="0" align="absmiddle">
						|LANG_VIEWRSSCREATE|</a>
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td  style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="../../comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">|LANG_VIEWRSS| (|TOTAL|)</td>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="25%" style="border-bottom:solid #cccccc 1px;border-right:solid #cccccc 1px;">
						<a href="veure.php?rss=|NOM|" target="_blank"><img src="../../comu/icon_veure.gif" alt="|LANG_VIEW|" width="19" height="16" border="0" align="absmiddle"></a>
