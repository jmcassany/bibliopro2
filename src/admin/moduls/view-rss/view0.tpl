...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">			
	...
	<tr>
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">	
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="50%" class="text10"><img src="../../comu/icon_plana.gif" width="33" height="18" alt="|LANG_YOUAREIN|" border="0" align="absmiddle">|LANG_YOUAREIN|: <a href="../../index.php">|LANG_HOME|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="../../utilitats/index.php">|LANG_UTILS|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="index.php">|LANG_VIEWRSSTITLE|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><font class="blau10b">|LANG_VIEWRSSMODIF|</font></td>
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="50%" style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="../../comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">|LANG_VIEWRSSMODIF|</td>
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			...
			<TR>
			   <TD class=text valign=top width="20%">|LANG_VIEWRSSTEMPLATE|:</TD>
			   <TD valign=top width="80%">|SELECT_PLANTILLA|</TD>
			</TR>

			<TR>
			   <TD class=text valign=top width="20%">|LANG_VIEWRSSLINK|:</TD>
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="LINKRSS"  VALUE="|LINKRSS|" SIZE="50" MAXLENGTH="250" class="formulari"></TD>
			</TR>
			<tr>
			   <TD class=text valign=top width="20%">|LANG_VIEWRSSMAX|:</TD>
			   <TD valign=top width="80%"><input type="text" name="MAXRSS" value="|MAXRSS|" size="4"></TD>
			</tr>
