	...
	class PieChart extends Chart
	{
		...
		*/
		...
		function PieChart($width = 600, $height = 250)
		{
			...
			$this->setMargin(5);  //outer margin
			$this->setLabelMarginLeft(10);  //30 label left margin
			$this->setLabelMarginRight(10); //30
			$this->setLabelMarginTop(10);   //50
			$this->setLabelMarginBottom(10);  //30 label bottom margin
			$this->setLabelMarginCenter(0);  //20 Set the margin between the pie image and the legend

			$this->setPieRatio(1);  //0.55
		...
		*/
		...
		function computePercent()
		{
			...
			//xin: usort($this->percent, array("PieChart", "sortPie"));
		}
