	...
	*/
	...
	class Chart
	{
		...
		*/
		...
		function printTitle()
		{
			$this->text->printCentered($this->img, ($this->labelMarginTop + $this->margin) / 2, $this->textColorTitol, $this->title, $this->text->fontCondensedBold);
		}
		...
		*/
		...
		function createImage()
		{
			...
			$this->textColorTitol = new Color(255, 102, 0);  //xin
