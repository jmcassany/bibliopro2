...
$CARDS_FIELDS['IDNL']           	= array('CUSTOM', 'CHAR', '');
$CARDS_FIELDS['COD']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['DESCRIPCIO']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['TITOL_DESCRIP 	']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['STAFF']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['CONTACTE']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['USUARI_HOUDINI']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['IdCam']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['VEURESUMARI']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['CAP']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['CONTINGUT']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['CONTENT']    = array('CUSTOM', 'CHAR',  '');
$CARDS_FIELDS['ESTILS_CONTINGUT']    = array('CUSTOM', 'CHAR',  '');
