...
<tr>
	<td colspan="2" align="right" style="padding: 0 40px 10px 0">	
		<a href="new.php" class="vermell10b"><img src="../../../../../public/media/comu/admin/icon_afegir_plana.gif" alt="" width="18" height="19" border="0" align="absmiddle"> |LANG_CREARBANNER|</a>
	</td>
</tr>
<tr>
	...
	<td colspan="2" valign="top" align="center">
		<table border="0" cellpadding="0" cellspacing="0" width="93%">				
			<tr bgcolor="#efefef">
				...
				<td align="left" class="gris11b" width="55%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="list.php?ordenar=titol&ordre=|ORDRE|&PAGE=|PAGE|" style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Títol banner</a></td>
