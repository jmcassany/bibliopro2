...
$CARDS_LISTFILTER .= " (TITOL LIKE '%$recerca%')";
...
if (!$Tpl->Ok) { htmlNewsletterError($messages["error2"]); exit; }
...
$total = count($cards);
if ($total == 0) {
    echo ("<tr><td width=\"20%\">&nbsp;</td><td class=\"text\" colspan=\"4\"><br /><strong>No s'ha trobat cap coincidència!</strong><br /><br /></td></tr>");
}
