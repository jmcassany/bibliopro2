	...
	<td colspan="2" align="center">
		<table border="0" cellpadding="0" cellspacing="0" width="93%">						
			<tr bgcolor="#efefef">
				...
				<td align="left" class="gris11b" width="45%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="busca.php?ordenar=titol&ordre=|ORDRE|&recerca=|RECERCA|&PAGE=|PAGE|" style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Títol notícia</a></td>
				<!-- <td align="left" class="gris11b" width="10%" valign="top" style="padding-left:5px;padding-top:5px;padding-bottom:5px;"><a href="busca.php?ordenar=model&ordre=|ORDRE|&recerca=|RECERCA|&PAGE=|PAGE|" style="background-color:|COLOR4|;" class="titolllistat">|ICO4||LANG_MODEL|</a></td> -->
			...
			<tr>
				...
				<!-- <td align="left" class="gris11" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;">|MODEL|</td> -->
