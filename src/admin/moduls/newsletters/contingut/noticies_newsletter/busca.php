...
$recerca = isset($_POST['recerca']) ? $_POST['recerca'] : (isset($_GET['recerca']) ? $_GET['recerca'] : '');
...
$CARDS_LISTFILTER .= " (TITOL LIKE '%$recerca%' OR RESUM LIKE '%$recerca%' OR  DESCRIPCIO LIKE '%$recerca%' OR NOM LIKE '%$recerca%' OR CARREC LIKE '%$recerca%' OR METATAGS LIKE '%$recerca%')";
