...
<html>
<head>
	<title><?php echo _t("website"); ?></title>
...
$file=$_GET['file'];
$data="";
$sql = "UPDATE " . TAULA_NOTICIESNEWSLETTER ." SET $camptaula='$data' where ID='$ID'";
...
if($result) {
    ...
    if (file_exists("$targetfilename")) {
        ...
        echo ("&#149;&nbsp;".$TIPOARXIU." "._t("eliminatda")."<br><br>");

    }else{
        echo ("&#149;&nbsp;".$TIPOARXIU." "._t("jahasiguteliminatda")."<br><br>");
    }
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						<tr>
							<td width="100%" align="center" >
								...
								<?php echo _t("esperiredirec"); ?><br><br>
								(<a href="view.php?ID=<?php echo $ID ?>"><?php echo _t("premisinovolesperar"); ?></a>)</td>
						</tr>
					</table>
				</td>
			</tr>
