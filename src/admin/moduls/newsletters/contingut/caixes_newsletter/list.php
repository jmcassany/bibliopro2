...
if ($ordenar == "titol") {
    ...
    $data['COLOR1']="#DEDEDE";
    $data['ICO1']="<img src=\"../../media/comu/admin/$ordre.gif\" width=\"10\" height=\"10\"  border=\"0\" align=\"absmiddle\" hspace=\"5\">";
    if ($ordre == "DESC") {
        $ordre = "ASC";
    } else {
        $ordre = "DESC";
...
if ($ordenar == "data") {
    ...
    $data['COLOR2']="#DEDEDE";
    $data['ICO2']="<img src=\"../../media/comu/admin/$ordre.gif\" width=\"10\" height=\"10\"  border=\"0\" align=\"absmiddle\" hspace=\"5\">";
    if ($ordre == "DESC") {
        $ordre = "ASC";
    } else {
        $ordre = "DESC";
...
if ($ordenar == "estat") {
    ...
    $data['COLOR3']="#DEDEDE";
    $data['ICO3']="<img src=\"../../media/comu/admin/$ordre.gif\" width=\"10\" height=\"10\"  border=\"0\" align=\"absmiddle\" hspace=\"5\">";
    if ($ordre == "DESC") {
        $ordre = "ASC";
    } else {
        $ordre = "DESC";
