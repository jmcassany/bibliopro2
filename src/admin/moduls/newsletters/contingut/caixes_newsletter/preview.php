...
$result = mysql_query("SELECT * FROM newsletter_caixes Where ID='$ID'");
...
<?php
	...
	//imatge
	$imatge = $row['IMATGE'];
    if ($row['IMATGE'] != "") $img = "<img src=\"../../../../../public/media/upload/caixes/$imatge\" border=\"0\">";

	//maquetaci�
	echo ("<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">");
	echo ("<tr><td valign=\"top\" style=\"padding:10px;\" align=\"center\">$titol</td></tr>");
	echo ("<tr><td valign=\"top\" style=\"padding:10px;\" align=\"center\">$img</td></tr>");
	echo ("<tr><td valign=\"top\" style=\"padding:10px;\" align=\"center\">$text</td></tr>");
	echo ("</table>");
	//fi maquetaci�
