		...
		<table border="0" cellpadding="0" cellspacing="0" width="93%">
				<tr>
					<td align="left" style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle">
						<img src="../../../../../public/media/comu/admin/kland_flexa.gif" width="21" height="13" border="0" align="bottom" /> Crear caixa
					</td>					
				</tr>				
			</table>
		</td>
	   ...
	   <td colspan="2" align="center">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="93%">
			...
			<TR style="margin: 10px 0;"> 
			   ...
			   <TD align="left" valign=top width="80%"><input type="text" name="TITOL" size="60" class="formulari" /></TD> 
			</TR>
			<TR style="margin: 10px 0;"> 
			...
			<TR style="margin: 10px 0;">   
			   <TD colspan="2" style="border-top:solid #0E449A 1px;" align="center">
			   		<input type="submit" name="accion" value="Crear" style="padding:5px" /> 
			   </TD> 
			</TR>
			</table>
