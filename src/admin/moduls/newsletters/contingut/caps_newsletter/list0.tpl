<table border="0" cellpadding="0" cellspacing="0" width="100%" >			
	...
	<tr>
		<td colspan="2" align="right" style="padding: 0 40px 10px 0">	
			<a href="new.php" class="vermell10b"><img src="../../../../../public/media/comu/admin/icon_afegir_plana.gif" alt="" width="18" height="19" border="0" align="absmiddle"> Crear capçalera</a>
		</td>
	</tr>
