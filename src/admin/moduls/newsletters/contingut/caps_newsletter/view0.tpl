		...
		<table border="0" cellpadding="0" cellspacing="0" width="93%">
				<tr>
					<td style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle">
						<img src="../../../../../public/media/comu/admin/kland_flexa.gif" width="21" height="13" border="0" align="bottom"> Editar capçalera
					</td>					
				</tr>				
			</table>
		</td>
	...
	<tr>
		...
		<table border="0" cellpadding="5" cellspacing="5" width="93%">
			...
			<TR> 
			   ...
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="TITOL" SIZE="60" MAXLENGTH="150" value="|TITOL|" class="formulari"></TD> 
			</TR> 
			<TR> 
