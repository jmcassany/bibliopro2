...
$result5 = $db->sql_query("SELECT * FROM newsletter_campanyes ".$wh_filtre.$wh_ordre.$wh_limit);

while ($row5 = $db->sql_fetchrow($result5)) {
    $rowAux = $db->sql_fetchrow( $db->sql_query("SELECT count(*) AS n1 FROM newsletter_destinataris WHERE IdCam = '".$row5['IdCam']."'") );
