...
<!--			</ol>-->
			...
			<div id="report_final" style="display: none;">
				...
				<p>Heu enviat <span id="numok">1</span> missatges correctament i <span id="numko">1</span> missatges no han pogut ser enviats. (<a href="#" onclick="document.getElementById('lliur').style.display='inline';">mostrar els detalls de l'enviament</a>)<br /><br /></p>
                ...
                |ERRORCONFI|
                <a href="../informes/resum.php?IdCam=|ID|"><img src="../media/gif/bt_tornar.jpg" width="120" height="39" alt="Tornar" /></a>
            </div>
        </div>
</div>