...
$total_estat = array();
$result7 = $db->sql_query("SELECT estat, count(*) AS n1 FROM newsletter_subscriptors WHERE IdLli = '$ID' GROUP BY estat");
...
function tractar_formulari() {
    ...
    $result5 = $db->sql_query("SELECT * FROM newsletter_subscriptors WHERE IdLli = '$ID'".$wh_estat);
