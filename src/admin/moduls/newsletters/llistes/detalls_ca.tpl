		...
		<div id="contingut">
			...
			<div class="dreta">
				...
				<ul>
                    ...
                    <li><a href="bounces.php?id=|ID|">Processar rebots</a></li>
					<li><a href="detalls.php?id=|ID|&amp;delbounces=true">Donar de baixar els subscriptors amb més de 5 rebots</a></li>
				</ul>
			</div>
						...
						<table>
							<thead>
								<tr>
        	                        ...
        	                        <th><a href="|LINK_5|">|ICO_5|Rebots</a></th>
							...
							<tbody>
								<tr>
									<td colspan="6"><strong>Mostrant del |REG_PRIMER| al |REG_ULTIM|, de |NUM_REGS| subscriptors</strong></td>
								</tr>
