	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			<TABLE width="100%" cellpadding="5" cellspacing="0" border="0">
				...
				<TR>
					<TD class=text valign=top width="22%">Descarregable:</TD>
					<TD valign=top width="40%">|DESCARGABLE|</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class=text valign=top width="22%">Estat descàrrega:</TD>
