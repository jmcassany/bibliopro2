...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="|CONFIG_URLADMIN|/comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">Descàrregues (|TOTAL|)</td>
							...
							<tr align="right">
								<td valign="middle" align="right">
									<label for="data_subl_desde">
										...
										<input type="text" name="data_subl_desde" id="data_subl_desde" maxlength="19" size="15">
									</label>
									<label for="fi_subl_fins">
										<span style="color: #fff;">fins</span>
										<input type="text" name="data_subl_fins" id="data_subl_fins" maxlength="19" size="15">
									</label>
								</td>
							</tr>
							<tr>
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#efefef">
					<td class="gris11b" ></td>
					<td class="gris11b"  valign="top" style="padding-left:0px;padding-top:5px;padding-bottom:5px;">Descarregable</td>
