<?php
	...
	// =========================
	// list definitions
	$CARDS_LISTSORTBY = 'FECHA_SOLICITUD ASC';
	...
	$DOWNLOADS_TABLE = 'PagoDescargas';
	$SUBLICENCES_TABLE = 'PagoSublicencias';
	$DONATIONS_TABLE = 'Donaciones';
	$USERS_TABLE = 'Usuarios';
	$QUESTIONNAIRES_TABLE = 'Cuestionarios';
	$DOWNLOADABLES_TABLE = 'Descargables';
