...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="|CONFIG_URLADMIN|/comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">Donacions (|TOTAL|)</td>
				...
				<!-- llegendes -->
				<tr>
					<td bgcolor="#ECECEC" style="padding:5px;border-bottom:solid #CCCCCC 1px;" class="text10" colspan="2">
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#efefef">
					<td class="gris11b" ></td>
					<td class="gris11b" valign="top" style="padding-left:0px;padding-top:5px;padding-bottom:5px;">Quantitat</td>
					<td class="gris11b" valign="top" style="padding-left:0px;padding-top:5px;padding-bottom:5px;"><a href="index.php?ordenar=data&amp;ordre=|ORDRE|"  style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Data</a></td>
				...
				<tr>
					...
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;background:#|COLOR|"><a href="view.php?ID=|ID|"><img src="|CONFIG_URLADMIN|/comu/icon_menus.gif" alt="" width="22" height="17" border="0" align="absmiddle"></a><a href="view.php?ID=|ID|" class="nompagina">|TOTAL|</a></td>
					...
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:0px;padding-top:5px;padding-bottom:5px;background:#|COLOR|"><a href="view.php?ID=|ID|" class="nompagina">|STATUS|</a></td>
