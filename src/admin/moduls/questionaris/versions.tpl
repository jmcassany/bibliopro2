...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td  style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="|CONFIG_URLADMIN|/comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">Versions del qüestionari (|TOTAL|)</td>
				...
				<tr>
					<td  bgcolor="#ECECEC" style="padding:5px;border-bottom:solid #CCCCCC 1px;" class="text10">
					   ...
					   <img src="|CONFIG_URLADMIN|/comu/icon_duplica.gif" alt="|LANG_DUPLICATE|" width="20" height="16" border="0" align="absmiddle" >Crea nova versió&nbsp;&nbsp;&nbsp;
					...
					<td align="right" bgcolor="#ECECEC" style="padding:5px;border-bottom:solid #CCCCCC 1px;" class="text10">
						...
						<a href="csv.php"><img src="|CONFIG_URLADMIN|/comu/ico_export_dades.gif" alt="Exportar a CSV" border="0" align="absmiddle"> Exportar a CSV</a>&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<!-- /navegacio pag -->
  				|RESULTAT|
		...
		<td colspan="2" style="padding:10px;" valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#efefef">
					...
					<td class="gris11b"  valign="top" style="padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="index.php?ordenar=version&amp;ordre=|ORDRE|"  style="background-color:|COLOR2|;" class="titolllistat">|ICO2|Versió</a></td>
				</tr>
				<!-- BLOCK_BEGIN_ROW  -->
				<tr>
					...
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID=|ID|"><img src="|CONFIG_URLADMIN|/comu/icon_menus.gif" alt="" width="22" height="17" border="0" align="absmiddle"></a><a href="view.php?ID=|ID|" class="nompagina" title="|NOM|">|NOM_CAST|</a></td>
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID=|ID|" class="nompagina">|AUTORS|</td>
   				<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID=|ID|" class="nompagina">|VERSION|</td>
				</tr>
				<!-- BLOCK_END_ROW  -->
			</table>
		</td>
