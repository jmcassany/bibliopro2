<?php
	...
	if ($ordenar == "precio"){
		$CARDS_LISTSORTBY = "PRECIO $ordre, TIPO_ENTIDAD ASC, PRECIO_AL DESC";
		$data['COLOR2']="#DEDEDE";
	...
	if ($ordenar == "precioAL"){
		$CARDS_LISTSORTBY = "PRECIO_AL $ordre, TIPO_ENTIDAD ASC, PRECIO DESC";
		$data['COLOR3']="#DEDEDE";
