<?php
	...
	// =========================
	// list definitions
	$CARDS_LISTSORTBY = 'TIPO_ENTIDAD ASC, PRECIO DESC, PRECIO_AL DESC';
	$CARDS_LISTFILTER = "";
	$CARDS_LISTLENGTH = 15;
	$CARDS_LISTSKIP = 10;
	...
	// personalitzats
	$CARDS_FIELDS['TIPO_ENTIDAD']            = array('CUSTOM', 'NUMBER',  '');
	$CARDS_FIELDS['PRECIO']            = array('CUSTOM', 'CHAR',  '');
	$CARDS_FIELDS['PRECIO_AL']            = array('CUSTOM', 'CHAR',  '');
