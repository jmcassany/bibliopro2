...
jQuery(function($){
	$("#data_subs_desde").mask("9999-99-99 99:99:99");
	$("#data_subs_fins").mask("9999-99-99 99:99:99");
});
function ordenar(){
...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<tr>
		<td colspan="2" style="padding:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td style="padding:8px;" bgcolor="#0E449A" class="blanc10b" valign="middle"><img src="|CONFIG_URLADMIN|/comu/kland_flexa.gif" width="21" height="13" border="0" align="bottom">Subscripcions (|TOTAL|)</td>
					...
					<!-- buscador -->
						...
						<table cellpadding="2" cellspacing="2" border="0">
							...
							<tr align="right">
								<td valign="middle" align="right">
									<label for="data_subs_desde">
										<span style="color: #fff;">Data activació des de:</span>
										<input type="text" name="data_subs_desde" id="data_subs_desde" maxlength="19" size="15">
									</label>
									<label for="data_subs_fins">
										<span style="color: #fff;">fins</span>
										<input type="text" name="data_subs_fins" id="data_subs_fins" maxlength="19" size="15">
									</label>
								</td>
							</tr>
							<tr>
				...
				<tr>
					...
					<td align="right" bgcolor="#ECECEC" style="padding:5px;border-bottom:solid #CCCCCC 1px;" class="text10">
						<a href="tipus/index.php"><img src="|CONFIG_URLADMIN|/comu/icon_gest_plantilles.gif" alt="Gestionar tipus de subscripció" border="0" align="absmiddle"></a> <a href="tipus/index.php">Gestionar preus de les subscripcions</a>
					</td>
				</tr>
				<!-- /navegacio pag -->
				|RESULTAT|
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#efefef">
					<td class="gris11b" ></td>
					<td class="gris11b"  valign="top" style="padding-left:0px;padding-top:5px;padding-bottom:5px;"><a href="index.php?ordenar=data&amp;ordre=|ORDRE|"  style="background-color:|COLOR1|;" class="titolllistat">|ICO1|Data activació</a></td>
					<td class="gris11b"  valign="top" style="padding-left:0px;padding-top:5px;padding-bottom:5px;"><a href="index.php?ordenar=status&amp;ordre=|ORDRE|"  style="background-color:|COLOR2|;" class="titolllistat">|ICO2|Estat</a></td>
				...
				<tr>
					...
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;background:#|COLOR|"><a href="view.php?ID=|ID|"><img src="|CONFIG_URLADMIN|/comu/icon_menus.gif" alt="" width="22" height="17" border="0" align="absmiddle"></a><a href="view.php?ID=|ID|" class="nompagina" title="|FECHA_ACTIVACION|">|FECHA_ACTIVACION|</a></td>
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;background:#|COLOR|"><a href="view.php?ID=|ID|" class="nompagina" title="|STATUS|">|STATUS|</a></td>
					<td class="gris10" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;background:#|COLOR|"><a href="view.php?ID=|ID|" class="nompagina" title="|USUARIO|">|USUARIO|</a></td>
				</tr>
				<!-- BLOCK_END_ROW  -->
			</table>
		</td>
