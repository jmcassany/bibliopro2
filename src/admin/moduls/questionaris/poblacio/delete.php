<?php
	...
	if (!isset($_POST['CONFIRM']) || $_POST['CONFIRM'] !='TRUE') {
	  htmlPageError('Error esborrant població de qüestionaris');
	}
	  ...
	  $missatge = t("errordeletenocheck");
		...
		foreach($_POST['CHECK'] as $key => $value) {
			...
			if (db_num_rows(
				...
				register_add("Població de qüestionaris eliminat", $row['VALOR']);
...
?>
	<tr>
		<td class="text">Les poblacions seleccionades han estat esborrades</td>
	</tr>
	<tr>
