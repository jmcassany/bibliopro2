<?php
	...
	if (!isset($_POST['CONFIRM']) || $_POST['CONFIRM'] !='TRUE') {
	  htmlPageError('Error esborrant malaltia de qüestionaris');
	}
	  ...
	  $missatge = t("errordeletenocheck");
		...
		foreach($_POST['CHECK'] as $key => $value) {
			...
			if (db_num_rows(
				...
				register_add("Malaltia de qüestionaris eliminada", $row['VALOR']);
...
?>
	<tr>
		<td class="text">Les malalties seleccionades han estat esborrades</td>
	</tr>
	<tr>
