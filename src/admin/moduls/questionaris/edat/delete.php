<?php
	...
	if (!isset($_POST['CONFIRM']) || $_POST['CONFIRM'] !='TRUE') {
	  htmlPageError('Error esborrant edat de qüestionaris');
	}
	  ...
	  $missatge = t("errordeletenocheck");
		...
		foreach($_POST['CHECK'] as $key => $value) {
			...
			if (db_num_rows(
				...
				register_add("Edat de qüestionaris eliminada", $row['VALOR']);
...
?>
	<tr>
		<td class="text">Les edats seleccionades han estat esborrades</td>
	</tr>
	<tr>
