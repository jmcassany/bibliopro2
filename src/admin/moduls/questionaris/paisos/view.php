<?php
   ...
   // CURRENT CARD DATA ================================================
	...
	if ($data['REDUCCION_AL'] == 1) { $data['REDUCCION_CHECKED'] = ' checked="checked"'; }
	else { $data['REDUCCION_CHECKED'] = ''; }

	if ($data['CE'] == 1) { $data['CE_CHECKED'] = ' checked="checked"'; }
	else { $data['CE_CHECKED'] = ''; }
