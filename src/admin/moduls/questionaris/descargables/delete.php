<?php
	...
	if (!isset($_POST['CONFIRM']) || $_POST['CONFIRM'] !='TRUE') {
	  htmlPageError('Error esborrant descarregable de qüestionaris');
	}
...
?>
	...
	<tr>
		...
		<b><a href="index.php?ID_CUEST=<?php echo urlencode($_GET['ID_CUEST']); ?>" class="botonavegacio"><?php echo t("continue") ?></a></b>
		</td>
	</tr>
</table>
