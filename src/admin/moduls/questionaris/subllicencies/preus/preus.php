<?php
	...
	$CARDS_TABLE = 'Sublicencias_precios';
	$SUBLICENCES_TABLES = 'Sublicencias';
	...
	// personalitzats
	$CARDS_FIELDS['ID_SUBLICENCIA']            = array('CUSTOM', 'NUMBER',  '');
	$CARDS_FIELDS['NUM_DE']            = array('CUSTOM', 'NUMBER',  '');
	$CARDS_FIELDS['NUM_HASTA']            = array('CUSTOM', 'NUMBER',  '');
	$CARDS_FIELDS['LUCRO']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['NO_LUCRO']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['INDIVIDUAL']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['LUCRO_AL']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['NO_LUCRO_AL']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['INDIVIDUAL_AL']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['LUCRO_SUBS']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['NO_LUCRO_SUBS']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['INDIVIDUAL_SUBS']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['LUCRO_SUBS_AL']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['NO_LUCRO_SUBS_AL']            = array('CUSTOM', 'CHAR',  'CHAR');
	$CARDS_FIELDS['INDIVIDUAL_SUBS_AL']            = array('CUSTOM', 'CHAR',  'CHAR');
