<?php
	...
	function getPageLink($page)
	{
		...
		return "index.php?ID_SUBLICENCIA=$_GET[ID_SUBLICENCIA]&ordenar=$ordenar&PAGE=$page".$textcerca;
	}
	...
	if ($ordenar == "hasta"){
		$CARDS_LISTSORTBY = "NUM_HASTA $ordre";
		$data['COLOR2']="#DEDEDE";
	...
	if ($ordenar == "nolucro"){
		$CARDS_LISTSORTBY = "NO_LUCRO $ordre";
		$data['COLOR4']="#DEDEDE";
	...
	if ($ordenar == "ind"){
		$CARDS_LISTSORTBY = "INDIVIDUAL $ordre";
		$data['COLOR5']="#DEDEDE";
