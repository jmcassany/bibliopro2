<?php
	...
	if ($ordenar == "telefon"){
		$CARDS_LISTSORTBY = "TELEFON $ordre";
		$data['COLOR3']="#DEDEDE";
...
// 		if (!empty($TIPO)) {
// 			if ($TIPO == '2') {
// 				$where = "WHERE IDAUTORES_CAST LIKE '%\"$data[ID]\"%'";
// 			}
// 			else {
// 				$where = "WHERE IDAUTORES_ORIGINAL LIKE '%\"$data[ID]\"%'";
// 			}
// 			$ctQ = db_query ("
// 				SELECT ID FROM `$QUESTIONNARIES_TABLE`
// 				$where
// 			");
// 			if (db_num_rows($ctQ) > 0) {
