		...
		<td colspan="2" style="padding:10px;" valign="top">
			<TABLE width="100%" cellpadding="5" cellspacing="0" border="0">
				<TR>
					...
					<TD valign=top width="80%"><INPUT TYPE="text" NAME="NOM"  VALUE="|NOM|" SIZE="40" MAXLENGTH="250" class="formulari"></TD>
				</TR>
				<TR>
					<TD class=text valign=top width="20%">Email:</TD>
					<TD valign=top width="80%"><INPUT TYPE="text" NAME="EMAIL"  VALUE="|EMAIL|" SIZE="40" MAXLENGTH="250" class="formulari"></TD>
				</TR>
				<TR>
					<TD class=text valign=top width="20%">Telèfon:</TD>
					<TD valign=top width="80%"><INPUT TYPE="text" NAME="TELEFON"  VALUE="|TELEFON|" SIZE="40" MAXLENGTH="250" class="formulari"></TD>
				</TR>
			</TABLE>
			<TABLE width="100%" cellpadding="5" cellspacing="0" border="0">
				<TR>
