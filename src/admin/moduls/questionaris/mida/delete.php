<?php
	...
	if (!isset($_POST['CONFIRM']) || $_POST['CONFIRM'] !='TRUE') {
	  htmlPageError('Error esborrant mida de qüestionaris');
	}
	  ...
	  $missatge = t("errordeletenocheck");
		...
		foreach($_POST['CHECK'] as $key => $value) {
			...
			if (db_num_rows(
				...
				register_add("Mida de qüestionaris eliminada", $row['VALOR']);
...
?>
	<tr>
		<td class="text">Les mides seleccionades han estat esborrades</td>
	</tr>
	<tr>
