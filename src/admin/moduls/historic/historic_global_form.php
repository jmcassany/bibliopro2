...
<form action="historic_global.php" method="post">
<?php echo htmlHeader(); ?>
	...
	<tr>
		<td colspan="2" style="padding:15px;">
			<table border="0" cellpadding="0" cellspacing="0" width="420" style="padding:3px;">
				...
				<tr>
					<td valign="top" rowspan="5" width="40"><img src="../../comu/ico_historic2.gif" alt="<?php echo t("registryhistoryviewall"); ?>" width="40" height="18" border="0"></td>
					<td class="blanc11b" bgcolor="#0E449A" style="padding:5px;"><?php echo t("registryhistoryviewall"); ?></td>
				</tr>


				<tr>
					<td class="text10" style="padding:10px;" bgcolor="#E6E6E6"><?php echo t("user"); ?>:

					<select class="formulari" name="LOGIN" style="width:200px;">
					<option value="%"><?php echo t("all"); ?></option>
					<?php
                    $users = new dbUsers();
                    $logins = $users->listLoginAll();
				...
				<tr>
					<td class="text10" style="padding-left:10px;padding-right:10px;" bgcolor="#E6E6E6">
				...
				<tr>
					...
					Ordenar per: <input type="radio" name="ORDRE" value="DATA DESC" checked><?php echo t("date"); ?> <input type="radio" name="ORDRE" value="LOGIN ASC"><?php echo t("user"); ?>
					</td>
				</tr>
				<tr>
