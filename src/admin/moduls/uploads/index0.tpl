...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #0E449A 5px;margin:10px;margin-bottom:0px;">
	...
	<!-- situacio Sou a -->
	<tr>
		<td class="text10" bgcolor="#C0CEE4" style="padding:6px;" colspan="2"><img src="../../comu/kland_blanc.gif" width="22" height="7" border="0" align="absmiddle"><b>|USERSTITOL|</b></td>
	</tr>
	<tr>
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="60%" class="text10"><img src="../../comu/icon_plana.gif" width="33" height="18" alt="|LANGETSA|" border="0" align="absmiddle">|LANGETSA|: <a href="../../index.php">|LANGHOME|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0"><a href="../../utilitats/index.php">|LANGUTILITATS|</a><img src="../../comu/kland_etsa.gif" width="19" height="5"  border="0">|USERSTITOL|</td>
...
|EDIT_OPTION|
<!--|CLONE_OPTION|
						<a href="moure.php?ID=|ID|&DIN=|DIN|&accio=up"><img src="../../comu/icon_pujaform.gif" alt="Pujar" width="13" height="14" border="0" align="absmiddle"   style="margin-right:4px;"></a>
						<a href="moure.php?ID=|ID|&DIN=|DIN|&accio=down" ><img src="../../comu/icon_baixaform.gif" alt="Baixar" width="13" height="14" border="0" align="absmiddle" ></a>
-->
|DELETE_OPTION|
					</td>
|INFO|
