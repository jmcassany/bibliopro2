...
//   include("check_moduls.php");
   ...
   if (!empty($cerca)) {
       ...
       $CARDS_LISTFILTER = "NOM_GRUP LIKE '%$cerca%' OR NOM_CARPETA LIKE '%$cerca%'";
   }
...
if($ordenar == ""){
  $CARDS_LISTSORTBY = 'NOM_GRUP DESC,ID DESC';
}
else if($ordenar == 'titol'){
	$CARDS_LISTSORTBY = 'NOM_GRUP '.$ordre;
	$data['COLOR1']="#DEDEDE";
...
$ITEMS['CARDS_CATEGORY2']['ESP'] =array('0_'.t("notcategoriesdefined"));
   ...
   $data['DESCRIPCIOCARPETA']= t("userstitle");
   $data['USERSTITOL'] = t("uploadgrouptitle");
...
<button type="submit" class="vermell10b" style="background-color:transparent;cursor:pointer;border:none;text-decoration: none;">
  <img src="../../comu/icon_afegir_plana.gif" alt="'.t("uploadgrouptitlenew").'" align="absmiddle" style="margin-right:5px;" />'.t("uploadgrouptitlenew").'
</button>
</form>
';
   }
...
$data['CAPCELERA'] = htmlHeader();
  ...
  if (!empty($cerca)) {
	if ($total == 0){
   		$data['RESULTAT']="<tr><td class=\"text10\" colspan=\"2\" style=\"padding-left:10px;\"><br>Recerca: <b>$cerca</b></td></tr>\n<tr><td class=\"grana\" colspan=\"2\" style=\"padding-left:20px;\"><br><img src=\"../../comu/houdini_alerta.gif\" width=\"19\" height=\"31\" alt=\"Error\" border=\"0\" align=\"absmiddle\">&nbsp;<b>No s'ha trobat cap coincid�ncia</b><br><br><a href=\"javascript:history.back();\" ><b><< Tornar</b></a></td></tr>";
	}else{
...
';
   ...
   if (accessGroupPerm('users_edit')) {
      $data['EDIT_OPTION'] = '
<a href="view.php?ID='.$data['ID'].'" ><img src="../../comu/icon_modifica.gif" alt="Editar" width="23" height="16" border="0" align="absmiddle" ></a>
';
      $data['INFO'] = '
<td class="gris11" width="35%" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID='.$data['ID'].'" class="gris11">'.$data['NOM_GRUP'].'</a></td>
<td class="gris11" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID='.$data['ID'].'" class="gris11">'.$data['CREATION_DAY'].'-'.$data['CREATION_MONTH'].'-'.$data['CREATION_YEAR'].' '.$data['CREATION_HOUR'].':'.$data['CREATION_MIN'].':'.$data['CREATION_SEC'].'</a></td>
<td class="gris11" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;"><a href="view.php?ID='.$data['ID'].'" class="gris11">'.$data['STATUS_X'].'</a></td>
<!--<td class="gris11" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;" align="center"><a href="view.php?ID='.$data['ID'].'" class="gris11">'.$data['ORDRE'].'</a></td>-->
      ';
   }
   else {
      $data['INFO'] = '
<td class="gris11" width="35%" valign="top" style="border-bottom:solid #cccccc 1px;padding-left:10px;padding-top:5px;padding-bottom:5px;">'.$data['NOM_GRUP'].'</td>
