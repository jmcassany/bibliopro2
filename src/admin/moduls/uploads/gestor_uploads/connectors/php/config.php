...
$fckphp_config['basedir'] = $CONFIG_PATHBASE.'/media' ;
/*==============================================================================*/
...
$fckphp_config['urlprefix']=$CONFIG_NOMCARPETA.'/media';
...
/*------------------------------------------------------------------------------*/
$fckphp_config['UserFilesPath'] = "/upload" ;
/*==============================================================================*/
...
$fckphp_config['auth']['HandlerClass'] = 'HoudiniUsers';
...
//File Area
/*$fckphp_config['ResourceAreas']['arxius'] =array(
...
//Image area
$fckphp_config['ResourceAreas']['imatges'] =array(
	'AllowedExtensions'	=>	array("jpg","gif","jpeg","png","tiff","tif"),
	'AllowedMIME'		=>	array(),
	'MaxSize'		=>	$UPLOAD_imgsize,
	'DiskQuota'		=>	-1,
	'HideFolders'		=>	array("^\."),
	'HideFiles'		=>	array("^\."),
	'AllowImageEditing'	=>	false
...
$fckphp_config['DebugOutput']="/home/o/obrador/share/Feines/fc/fck_conn_dbg";
...
/*------------------------------------------------------------------------------*/
$fckphp_config['ResourceTypes'] = array('arxius','imatges');
