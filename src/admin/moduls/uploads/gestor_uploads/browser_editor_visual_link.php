...
<html>
	...
	<frameset cols="150,*" framespacing="0" bordercolor="#f1f1e3" frameborder="no" class="Frame_none">
		<frameset rows="108,*" framespacing="0"  class="Frame_r">
			<frame src="frmresourcetype_vincles.html" scrolling="no" frameborder="no">
		...
		<frameset rows="50,*,50" framespacing="0" class="Frame_none">
			...
			<frame name="frmResourcesList" id="mainWindow" src="frmresourceslist3.html" scrolling="auto" frameborder="no">
			<frameset cols="150,*,0" framespacing="0" frameborder="no" class="Frame_t">
				<frame name="frmCreateFolder" id="frmCreateFolder" src="frmcreatefolder3.html" scrolling="no" frameborder="no">
				<frame name="frmUpload" id="frmUpload" src="frmupload3.html" scrolling="no" frameborder="no">
