...
<head>
<?php echo htmlMetas(); ?>
<meta http-equiv="refresh" content="2;url=view.php?ID=<?php echo $ID; ?>&DIN=<?php echo $DIN; ?>&PAGE=<?php echo $pagina; ?>">
</head>
<body>
...
<?php
   ...
   $data="";
   $sql = "UPDATE $TAULA SET $camptaula='$data' where ID='$ID'";
   $result = db_query($sql);
   if($result) {
		if ($categoria == 1) {
			$targetfilename = $CONFIG_PATHUPLOADAD."/$file";
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					<tr>
						<td width="100%" align="center" >
							...
							(<a href="view.php?ID=<?php echo $ID; ?>&DIN=<?php echo $DIN; ?>&PAGE=<?php echo $pagina; ?>"><?php echo t("notwait"); ?></a>)</td>
					</tr>
				</table>
			</td>
		</tr>
