...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #F66013 5px;margin:10px;margin-bottom:0px">
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			...
			<TR>
			   <TD class=text valign=top >|LANGFORMSUBTITLE|:</TD>
			   <TD valign=top ><INPUT TYPE="text" NAME="SUBTITOL" VALUE="|SUBTITOL|" SIZE="50" MAXLENGTH="250" class="formulari"></TD>
			</TR>


			<TR>
			   <TD class=text valign=top>|LANGFORMRESUM|:</TD>
			   <TD valign=top >
|EDITOR_RESUM|
				</TD>
			</TR>
...
|EDITOR_DESCRIPCIO|
			...
			<TR>
			   <TD class=text valign=top >|LANGFORMDATE|:</TD>
			   <TD valign=top ><INPUT TYPE="text" NAME="DATA"  VALUE="|DATA|" SIZE="50" MAXLENGTH="250"  class="formulari"></TD>
			</TR>

			<TR>
			   <TD class=text valign=top >|LANGFORMAUTHOR|:</TD>
			   <TD valign=top ><INPUT TYPE="text" NAME="AUTOR"  VALUE="|AUTOR|" SIZE="50" MAXLENGTH="250"  class="formulari"></TD>
			</TR>
			   ...
			   <TD  valign=top  class="text10" colspan=2><b>|LANGFORMLINK|:</b>
					...
					<table cellpadding="0" cellspacing="0" border="0" width="558" style="border:solid #CCCCCC 1px;">
						...
						<tr style="padding:5px;">
							...
							<td><INPUT TYPE="text" NAME="LINK2"  VALUE="|LINK2|" SIZE="50" MAXLENGTH="250" class="formulari" style="width:190"></td>
							<td><INPUT TYPE="text" NAME="TEXTLINK2"  VALUE="|TEXTLINK2|" SIZE="50" MAXLENGTH="250" class="formulari" style="width:190"></td>
							<td align="center">|SELECT_FINESTRA2|</td>
						</tr>
						<tr style="padding:5px;">
							<td class="text10">3</td>
							<td><INPUT TYPE="text" NAME="LINK3"  VALUE="|LINK3|" SIZE="50" MAXLENGTH="250" class="formulari" style="width:190"></td>
							<td><INPUT TYPE="text" NAME="TEXTLINK3"  VALUE="|TEXTLINK3|" SIZE="50" MAXLENGTH="250" class="formulari" style="width:190"></td>
							<td align="center">|SELECT_FINESTRA3|</td>
						</tr>
					</table>
			...
			<TR>
			   <TD  valign=top  class="text10" colspan=2><b>|LANGFORMIMAGE|:</b>
					...
					<table cellpadding="0" cellspacing="0" border="0" width="558" style="border:solid #CCCCCC 1px;">
						...
						<tr style="padding-top:5px;">
							<td class="text10" width="20%" style="padding:5px;">|IMATGE2|</td>
							<td style="padding:5px;" width="80%"><input type="file" name="img2" size=50 class="formulari" style="width:250px;"></td>
						</tr>
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|LANGFORMTEXT|</td>
							<td style="padding:5px;" width="80%"><INPUT TYPE="text" NAME="PEU_IMATGE2"  VALUE="|PEU_IMATGE2|" MAXLENGTH="250" class="formulari" style="width:160"></td>
						</tr>

						<tr style="padding-top:5px;">
							<td class="text10" width="20%" style="padding:5px;">|IMATGE3|</td>
							<td style="padding:5px;" width="80%"><input type="file" name="img3" size=50 class="formulari" style="width:250px;"></td>
						</tr>
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|LANGFORMTEXT|</td>
							<td style="padding:5px;" width="80%"><INPUT TYPE="text" NAME="PEU_IMATGE3"  VALUE="|PEU_IMATGE3|" MAXLENGTH="250" class="formulari" style="width:160"></td>
						</tr>
			...
			<TR>
			   <TD  valign=top  class="text10" colspan=2><b>|LANGFORMFILE|:</b>
			   		<!-- vincles -->
					<table cellpadding="0" cellspacing="0" border="0" width="558" style="border:solid #CCCCCC 1px;">
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|ADJUNT1|</td>
							<td style="padding:5px;" width="80%"><input type="file" name="file1" size=50 class="formulari" style="width:250px;"></td>

						</tr>
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|LANGFORMTEXT|</td>
							<td style="padding:5px;" width="80%"><INPUT TYPE="text" NAME="TEXT_ADJUNT1"  VALUE="|TEXT_ADJUNT1|" MAXLENGTH="250" class="formulari" style="width:160"></td>
						</tr>
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|ADJUNT2|</td>
							<td style="padding:5px;" width="80%"><input type="file" name="file2" size=50 class="formulari" style="width:250px;"></td>

						</tr>
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|LANGFORMTEXT|</td>
							<td style="padding:5px;" width="80%"><INPUT TYPE="text" NAME="TEXT_ADJUNT2"  VALUE="|TEXT_ADJUNT2|" MAXLENGTH="250" class="formulari" style="width:160"></td>
						</tr>
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|ADJUNT3|</td>
							<td style="padding:5px;" width="80%"><input type="file" name="file3" size=50 class="formulari" style="width:250px;"></td>

						</tr>
						<tr>
							<td class="text10" width="20%" style="padding:5px;">|LANGFORMTEXT|</td>
							<td style="padding:5px;" width="80%"><INPUT TYPE="text" NAME="TEXT_ADJUNT3"  VALUE="|TEXT_ADJUNT3|" MAXLENGTH="250" class="formulari" style="width:160"></td>
						</tr>
					</table>
			   </TD>
			</TR>
			<TR>
			   <TD  valign=top  class="text10" colspan=2><b>|LANGFORMDATE| |LANG_CALENDAR|:</b>
			   		<!-- dates calendari -->
					<table cellpadding="0" cellspacing="0" border="0" width="558" style="border:solid #CCCCCC 1px;">
						<tr>
							<td class="text10" width="80" style="padding:5px;">|LANG_DATE| |LANG_START|: (|LANG_DATEFORMAT|)</td>
							<td class="text10" style="padding:5px;"><input type="text" id="CALENDAR_START_TIME" name="CALENDAR_START_TIME" value="|CALENDAR_START_TIME_DAY|/|CALENDAR_START_TIME_MONTH|/|CALENDAR_START_TIME_YEAR|" maxlength="10" class="formulari" style="width:80px;"> <button type="reset" id="CALENDAR_START_TIME_BUTTON" class="boto_calendari" title="|LANG_DINAMICSFORMSELECTDATA|"><img src="../comu/bt_calendari.gif" alt="|LANG_DINAMICSFORMSELECTDATA|"  /></button>
							<input type="hidden" name="CALENDAR_START_TIME_HOUR" value="|CALENDAR_START_TIME_HOUR|"><input type="hidden" name="CALENDAR_START_TIME_MIN" value="|CALENDAR_START_TIME_MIN|"><input type="hidden" name="CALENDAR_START_TIME_SEC" value="|CALENDAR_START_TIME_SEC|">
							</td>

							<td class="text10" width="80" style="padding:5px;">|LANG_DATE| |LANG_END|: (|LANG_DATEFORMAT|)</td>
							<td class="text10" style="padding:5px;"><input type="text" id="CALENDAR_END_TIME" name="CALENDAR_END_TIME" value="|CALENDAR_END_TIME_DAY|/|CALENDAR_END_TIME_MONTH|/|CALENDAR_END_TIME_YEAR|" maxlength="10" class="formulari" style="width:80px;"> <button type="reset" id="CALENDAR_END_TIME_BUTTON" class="boto_calendari" title="|LANG_DINAMICSFORMSELECTDATA|"><img src="../comu/bt_calendari.gif" alt="|LANG_DINAMICSFORMSELECTDATA|"/></button>
							<input type="hidden" name="CALENDAR_END_TIME_HOUR" value="|CALENDAR_END_TIME_HOUR|"><input type="hidden" name="CALENDAR_END_TIME_MIN" value="|CALENDAR_END_TIME_MIN|"><input type="hidden" name="CALENDAR_END_TIME_SEC" value="|CALENDAR_END_TIME_SEC|">
							</td>
						</tr>
					</table>
<script type="text/javascript">
    Calendar.setup({
        inputField     :    "CALENDAR_START_TIME",      // id of the input field
        ifFormat       :    "%d/%m/%Y",       // format of the input field
        showsTime      :    false,            // will display a time selector
        button         :    "CALENDAR_START_TIME_BUTTON",   // trigger for the calendar (button ID)
...
<script type="text/javascript">
    Calendar.setup({
        inputField     :    "CALENDAR_END_TIME",      // id of the input field
        ifFormat       :    "%d/%m/%Y",       // format of the input field
        showsTime      :    false,            // will display a time selector
        button         :    "CALENDAR_END_TIME_BUTTON",   // trigger for the calendar (button ID)
        singleClick    :    true,           // double-click mode
        step           :    1,            // show all years in drop-down boxes (instead of every other year as default)
        weekNumbers	   :    false
    });
