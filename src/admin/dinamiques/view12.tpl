...
|EDITOR_DESCRIPCIO|
			...
			<TR>
			   ...
			   <TD valign=top >
			   <input type="text" name="CREATION_DAY" value="|CREATION_DAY|" maxlength="2" class="formulari" style="width:25px;">
								/ <input type="text" name="CREATION_MONTH" value="|CREATION_MONTH|" maxlength="2" class="formulari" style="width:25px;">
				                / <input type="text" name="CREATION_YEAR" value="|CREATION_YEAR|" maxlength="4" class="formulari" style="width:50px;"> (|LANGFORMDATEFORMAT|)
								<input type="hidden" name="CREATION_HOUR" value="00" />
								<input type="hidden" name="CREATION_MIN" value="00" />
								<input type="hidden" name="CREATION_SEC" value="00" />
				</TD>
