...
<table border="0" cellpadding="0" cellspacing="0" width="760" style="border:solid #F66013 5px;margin:10px;margin-bottom:0px">
	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			...
			<TR>
			   <TD class=text valign=top width="20%"><?php echo t("dinamicsformsubtitle"); ?>:</TD>
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="SUBTITOL" SIZE="50" MAXLENGTH="250" class="formulari"></TD>
			</TR>
			<TR>
...
<?php echo editor_entry('DESCRIPCIO', '','Antaviana'); ?>
			...
			<TR>
			   <TD class=text valign=top width="20%"><?php echo t("author"); ?>:</TD>
			   <TD valign=top width="80%"><INPUT TYPE="text" NAME="AUTOR" SIZE="50" MAXLENGTH="250"  class="formulari"></TD>
			</TR>
			...
			<TR>
			   <TD  valign=top  class="text10" colspan=2><b><?php echo t("date")." ".t("calendar"); ?>:</b>
			   		<!-- dates calendari -->
					<table cellpadding="0" cellspacing="0" border="0" width="558" style="border:solid #CCCCCC 1px;">
						<tr>
							<td class="text10" width="80" style="padding:5px;"><?php echo t("date")." ".t("start"); ?>: (<?php echo t("dateformat"); ?>)</td>
							<td class="text10" style="padding:5px;"><input type="text" id="CALENDAR_START_TIME" name="CALENDAR_START_TIME" value="<?php echo date("d/m/Y");?>" maxlength="10" class="formulari" style="width:80px;"> <button type="reset" id="CALENDAR_START_TIME_BUTTON" class="boto_calendari" title="<?php echo t("dinamicsformselectdata"); ?>"><img src="../comu/bt_calendari.gif" alt="<?php echo t("dinamicsformselectdata"); ?>"  /></button>
							<input type="hidden" name="CALENDAR_START_TIME_HOUR" value="00"><input type="hidden" name="CALENDAR_START_TIME_MIN" value="00"><input type="hidden" name="CALENDAR_START_TIME_SEC" value="00">
							</td>

							<td class="text10" width="80" style="padding:5px;"><?php echo t("date")." ".t("end"); ?>: (<?php echo t("dateformat"); ?>)</td>
							<td class="text10" style="padding:5px;"><input type="text" id="CALENDAR_END_TIME" name="CALENDAR_END_TIME" value="<?php echo date("d/m/Y");?>" maxlength="10" class="formulari" style="width:80px;"> <button type="reset" id="CALENDAR_END_TIME_BUTTON" class="boto_calendari" title="<?php echo t("dinamicsformselectdata"); ?>"><img src="../comu/bt_calendari.gif" alt="<?php echo t("dinamicsformselectdata"); ?>"/></button>	
							<input type="hidden" name="CALENDAR_END_TIME_HOUR" value="23"><input type="hidden" name="CALENDAR_END_TIME_MIN" value="59"><input type="hidden" name="CALENDAR_END_TIME_SEC" value="59">		    	                
							</td>
						</tr>						
					</table>
<script type="text/javascript">
