...
<?php echo editor_entry('DESCRIPCIO', '','Antaviana'); ?>
			...
			<TR>
			   ...
			   <!-- <TD valign=top width="80%"><INPUT TYPE="text" NAME="DATA" SIZE="50" MAXLENGTH="250"  class="formulari"></TD>
				-->
			   <TD valign=top width="80%">
			   <input type="text" name="CREATION_DAY" value="<?php echo date("d");?>" maxlength="2" class="formulari" style="width:25px;" />
								/ <input type="text" name="CREATION_MONTH" value="<?php echo date("m");?>" maxlength="2" class="formulari" style="width:25px;" />
				                / <input type="text" name="CREATION_YEAR" value="<?php echo date("Y");?>" maxlength="4" class="formulari" style="width:50px;" /> (<?php echo t("dateformat"); ?>)
