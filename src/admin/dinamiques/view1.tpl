	...
	<tr>
		...
		<td colspan="2" style="padding:10px;" valign="top">
			...
			<TR>
			   ...
			   <TD valign=top ><INPUT TYPE="text" NAME="LINK1"  VALUE="|LINK1|" SIZE="50" MAXLENGTH="250"  class="formulari"></TD>
			</TR>

			<TR>
			   <TD class=text valign=top >Descripció:</TD>
