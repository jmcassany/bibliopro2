		...
		<td colspan="2" style="padding-left:5px;padding-right:5px;padding-top:5px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
                    ...
                    <img src="../comu/kland_etsa.gif" width="19" height="5"  border="0">
                    <font class="blau10b">Generar carpetes</font>
                    </td>
...
function generate($pare) {
	$result = db_query("SELECT * FROM CARPETES where CATEGORY1='0' and PARE=".$pare);
	while ($row = db_fetch_array($result)) {
		folderGenerate(folderPath($pare), $row['NOMCARPETA']);
		echo '
<img src="../comu/miniico_nova.gif" alt="Ok" border="0" align="left" ><font class="blau11b">Carpeta creada</font> |'.folderPath($pare).'/'.$row['NOMCARPETA'].'<br><br>
	';
