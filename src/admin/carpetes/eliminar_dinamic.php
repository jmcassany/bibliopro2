...
if (isset($_POST['callback']) && isset($_POST['ID']) && isset($_POST['carpeta']) && $_POST['carpeta'] != '' && isset($_POST['pare']) && $_POST['pare'] != '') {
  ...
  if (dinFolderDelete($_POST['ID'])) {

    $missatge=t("foldersregistrydelete").": <b>".$_POST['carpeta']."</b>";

    register_add(t("foldersregistrydelete"), $carpeta);

  } else {
    $missatge= ("<img src=\"../comu/houdini_alerta.gif\" width=\"19\" height=\"31\" alt=\"Alert\" border=\"0\" align=\"absmiddle\"> <font class=\"grana\">".t("folderserrordeletedb")."</font>");
  }
...
<table  border="0" cellpadding="0" cellspacing="0">
			...
			<b><a href="index.php?path=<?php echo $_POST['ruta']; ?>" class="botonavegacio"><?php echo t("continue"); ?></a></b>
			<br><br>
