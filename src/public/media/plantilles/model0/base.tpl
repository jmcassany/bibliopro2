            ...
            <tr>
                <td colspan="3" style="background:#fcad56">
                    <p style="color:#333; margin: 8px 0 6px 20px">
                        |DESCRIPCIO_BUTLLETI| <span style="text-align:right; color:#FFF;"> <a style="ont-size:0.75em; color:#000; float: right; margin-right: 20px; text-decoration:none;" href="|URL_TORNAR|"><< Volver a la portada</a></span>
                    </p>
                </td>
            </tr>
        </thead>
