...
$idioma = 'es';
$pare = '2';
$filAriadnaArray = array(0 => array('link' => '//index.html' , 'title' => 'Portada' , 'nom' => 'Portada') , 1 => array('link' => '/que-es/index.html' , 'title' => 'Qué es BiblioPRO' , 'nom' => 'Qué es BiblioPRO') , 2 => array('link' => '' , 'title' => 'Equipo' , 'nom' => 'Equipo'));
$folderArray = array(2 => 'que-es');
$folderIds = array(0 => 2);
$folderUrl = '/que-es';
$pageUrl = '/que-es';

$nomTaula = 'editora_5'; $pageUrl = $_SERVER["REQUEST_URI"]
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
	...
	<head>
		...
		?>
		<title>!METAS_TITLE!Equipo - BiblioPRO</title>
...
<?php
$directori = '2,5';
$url = '/que-es/comite-directivo';
$rutaplana = ($pos = strpos('/que-es/comite-directivo', '?')) ? substr('/que-es/comite-directivo', 0, ($pos-1)) : '/que-es/comite-directivo';
